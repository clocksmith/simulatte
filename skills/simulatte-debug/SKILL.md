...
description: Reproduce and fix Simulatte prompt, retrieval, graph, simulation, visual compiler, rendering, settlement, browser, model, cache, or deployment failures. Use when user intent, receipts, and visible pixels disagree or pipeline performance regresses.
---
...
Patch the producer at the first invalid boundary and add a fixture that preserves the
