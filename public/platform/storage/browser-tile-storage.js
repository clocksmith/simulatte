(function attachBrowserTileStorage(root, factory) {
  const api = factory();
  if (typeof module === 'object' && module.exports) module.exports = api;
  root.SimulatteBrowserTileStorage = api;
})(typeof globalThis !== 'undefined' ? globalThis : window, function createBrowserTileStorageModule() {
  ...
  function storageError(code, evidence = null) {
    ...
    error.name = 'SimulatteBrowserStorageError';
    error.code = code;
