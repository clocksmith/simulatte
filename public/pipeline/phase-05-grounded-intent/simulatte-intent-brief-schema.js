(function attachSimulatteIntentBriefSchema(root, factory) {
  ...
  const INTENT_BRIEF_MODEL_STACK = Object.freeze({
    retrieval: 'google-embeddinggemma-300m-q4k-ehf16-af32',
    structurer: 'gemma-3-270m-it-intent-structurer',
    reranker: 'simulatte.deterministic-catalog-score-fusion.v1',
