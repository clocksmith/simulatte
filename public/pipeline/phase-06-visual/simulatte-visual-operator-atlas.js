(function attachSimulatteVisualOperatorAtlas(root, factory) {
  ...
  const VISUAL_OPERATOR_MAPPINGS = Object.freeze([
    ...
    mapping(
      ...
      ['phase', 'melt', 'freeze', 'crust', 'vaporize', 'condense', 'boil', 'solidify'],
  ...
  function requiredTermsForMapping(id, matchTerms = []) {
    const core = {
      ...
      'visual.operator.fluid-advection.v1': ['flow', 'fluid', 'water', 'river', 'ocean', 'fjord', 'meltwater', 'wind', 'coolant', 'airflow', 'velocity', 'microfluidic', 'dose', 'pump', 'channel', 'channels', 'droplet', 'surge', 'tidal', 'brackish', 'swim', 'swims', 'swimming', 'underwater', 'pool'],
      ...
      'visual.operator.optical-ray.v1': ['light', 'sunlight', 'shadow', 'shadows', 'laser', 'lens', 'photon', 'caustic', 'refraction'],
