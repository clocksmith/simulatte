(() => {
  const ENGINE_SRC = './app/session/simulatte-scenario-engine.js';
  const PARTICLE_SRC = './pipeline/phase-08-render/simulatte-particle-field.js';
  const CORE_SRC = './app/session/simulatte-world-core.js';
  const RENDER_SRC = './app/session/simulatte-world-rendering.js';
