(function attachSimulatteConstructionParts(root) {
  ...
  const NUMBER_WORDS = Object.freeze({
    ...
    function constructionPartDescriptors(construction = {}) {
      ...
      const hints = scope.uniqueList(sourceHints).slice(0, 20);
    ...
    root.SimulattePhaseModuleRegistry.define('compositionGraph', 'simulatte-construction-parts.js', {
      constructionEvidencePartCoverage,
      ...
      constructionCorePrimitive,
      constructionPartCount,
      constructionMaterialPalette,
      constructionMinimumScale,
      constructionGeometrySafeId,
      constructionEscapeRegExp,
    });
