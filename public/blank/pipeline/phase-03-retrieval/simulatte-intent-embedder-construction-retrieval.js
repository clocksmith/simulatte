  ...
  with (scope) {
    ...
    function slotRerankSummary(bySlot = []) {
      ...
      return {
        ...
        prefixTokenizationDurationMs: Number(sum('prefixTokenizationDurationMs').toFixed(3)),
        prefixResetDurationMs: Number(sum('prefixResetDurationMs').toFixed(3)),
        prefixPrimingDurationMs: Number(sum('prefixPrimingDurationMs').toFixed(3)),
