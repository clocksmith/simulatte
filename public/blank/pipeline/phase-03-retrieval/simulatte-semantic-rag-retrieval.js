(function attachSimulatteSemanticRagretrieval(root) {
  const scope = root.SimulattePhaseModuleRegistry.family('semanticRag');
    ...
    const GROUNDING_BASIS_CARDS = Object.freeze([
        scope.basisCard('ground.small-mammal-body', 'class', 'small mammal soft body with limb contact gait and fur', {
        ...
        scope.basisCard('ground.large-mammal-body', 'class', 'large articulated soft body with higher mass and gait force', {
        ...
        scope.basisCard('ground.articulated-body', 'class', 'articulated biological body approximated as soft capsules and contact points', {
        ...
        scope.basisCard('ground.winged-body', 'class', 'winged moving body with lift, drag, soft or rigid shell', {
        ...
        scope.basisCard('ground.swimmer-body', 'class', 'streamlined body interacting with fluid through buoyancy and drag', {
        ...
        scope.basisCard('ground.segmented-body', 'class', 'segmented tiny body with many contact legs and swarm behavior', {
        ...
        scope.basisCard('ground.plant-body', 'class', 'rooted plant body with branching structure, biomass, moisture, and growth', {
        ...
        scope.basisCard('ground.branching-network', 'class', 'branching graph network embedded in matter or terrain', {
        ...
        scope.basisCard('ground.biological-colony', 'class', 'population or fungal colony over substrate with diffusion and growth', {
        ...
        scope.basisCard('ground.rotating-apparatus', 'component', 'rotating apparatus built from circular body, axle, support, track, and inertia', {
        ...
        scope.basisCard('ground.wheeled-vehicle', 'component', 'vehicle with chassis, wheels, rolling friction, and collision shell', {
        ...
        scope.basisCard('ground.constrained-vehicle', 'component', 'vehicle constrained to track or rail with coupled rigid bodies', {
        ...
        scope.basisCard('ground.rigid-machine', 'component', 'rigid machine frame with motors, links, forces, and energy accounting', {
        ...
        scope.basisCard('ground.articulated-machine', 'component', 'linked rigid machine with joints, motors, and controlled motion', {
        ...
        scope.basisCard('ground.gear-train', 'component', 'interlocked rotating gears exchanging torque through constraints', {
        ...
        scope.basisCard('ground.pendulum', 'component', 'mass constrained by pivot with gravity, angular motion, and damping', {
        ...
        scope.basisCard('ground.conveyor', 'component', 'moving belt and rollers transporting objects by friction', {
        ...
        scope.basisCard('ground.lifting-machine', 'component', 'boom, pulley, cable, load, and tensile constraint system', {
        ...
        scope.basisCard('ground.flexible-cable', 'component', 'flexible tensile curve with tension, sag, and contact', {
        ...
        scope.basisCard('ground.container', 'component', 'container with boundary surface, contents, collision, and mass ledger', {
        ...
        scope.basisCard('ground.containment', 'relation', 'containment relation reduced to boundary, interior volume, and contact constraints', {
        ...
        scope.basisCard('ground.fluid-domain', 'component', 'fluid domain with pressure, velocity, advection, buoyancy, and surface boundary', {
        ...
        scope.basisCard('ground.fluid-channel', 'component', 'channelized flow through terrain or pipe with erosion and pressure', {
        ...
        scope.basisCard('ground.fluid-network', 'component', 'pipe-valve-pump graph carrying fluid pressure and flow', {
        ...
        scope.basisCard('ground.fluid-vessel', 'component', 'closed vessel or drum containing fluid with pressure and wall contact', {
        ...
        scope.basisCard('ground.floating-vessel', 'component', 'hull interacting with water by buoyancy, drag, and propulsion', {
        ...
        scope.basisCard('ground.thermal-machine', 'component', 'thermal system with heat source, sink, phase change, and loss ledger', {
        ...
        scope.basisCard('ground.thermal-fluid-machine', 'component', 'machine coupling pump, heater, valve, vessel, and flowing fluid', {
        ...
        scope.basisCard('ground.optical-element', 'component', 'optical element with transparent surface, ray propagation, refraction, and absorption', {
        ...
        scope.basisCard('ground.optical-source', 'component', 'light source with radiance, beam direction, and optical port', {
        ...
        scope.basisCard('ground.radiation-source', 'component', 'radiation source for sun, lamp, star, or heat emission', {
        ...
        scope.basisCard('ground.magnetic-source', 'component', 'magnetic source with dipole field and force coupling', {
        ...
        scope.basisCard('ground.electrical-machine', 'component', 'electrical machine or source with conductor, field, load, and heat loss', {
        ...
        scope.basisCard('ground.electrical-network', 'component', 'electrical graph with nodes, traces, signals, current, delay, and heat', {
        ...
        scope.basisCard('ground.energy-storage', 'component', 'stored energy reservoir with charge, discharge, heat, and conservation ledger', {
        ...
        scope.basisCard('ground.granular-terrain', 'component', 'granular or rocky terrain with heightfield, slope, friction, and erosion', {
        ...
        scope.basisCard('ground.weather-vortex', 'component', 'rotating atmospheric vortex with pressure, advection, particles, and debris contact', {
        ...
        scope.basisCard('ground.electrical-discharge', 'event', 'branching electric discharge through gas with heat, plasma, and shock pressure', {
        ...
        scope.basisCard('ground.ice-mass', 'component', 'solid ice mass with phase change, gravity creep, fracture, and meltwater flow', {
        ...
        scope.basisCard('ground.granular-flow', 'event', 'granular mass flow downhill with gravity, contact, friction, and deposition', {
        ...
        scope.basisCard('ground.volcanic-system', 'component', 'geologic pressure and heat source with lava flow, ash, and gas plume', {
        ...
        scope.basisCard('ground.structural-span', 'component', 'load-bearing span with supports, compression, tension, wind, and vibration', {
        ...
        scope.basisCard('ground.network-system', 'composition', 'network system with nodes, edges, queue service, demand, and delay', {
        ...
        scope.basisCard('ground.machine-line', 'composition', 'machine line of motors, conveyors, sensors, controllers, and ledgered energy', {
        ...
        scope.basisCard('ground.instrumented-bench', 'scene', 'instrumented test bench with source, sample, sensor, controller, and readout ledger', {
        ...
        scope.basisCard('ground.celestial-body', 'scene', 'celestial or orbital body with gravity, radiation, rock, and motion path', {
        ...
        scope.basisCard('ground.collision-event', 'event', 'contact event reduced to manifold, impulse, friction, restitution, damping, and energy ledger', {
        ...
        scope.basisCard('ground.rolling-motion', 'event', 'rolling event with circular body, contact patch, angular velocity, and friction', {
        ...
        scope.basisCard('ground.rolling-body', 'component', 'round body with spin, bounce, contact patch, inertia, and friction', {
        ...
        scope.basisCard('ground.combustion-event', 'event', 'combustion event with fuel, oxygen, flame, smoke, heat, and mass-energy ledger', {
        ...
        scope.basisCard('ground.erosion-event', 'event', 'erosion event with water flow, sediment, slope, and changing terrain heightfield', {
        ...
        scope.basisCard('ground.wave-event', 'event', 'wave or vibration event with oscillator, pressure, propagation, and damping', {
        ...
        scope.basisCard('ground.pressure-event', 'event', 'rapid pressure event with expanding field, impulse, and damping', {
        ...
        scope.basisCard('ground.mechanical-joint', 'relation', 'mechanical attachment reduced to constraint, pivot, support, and force transfer', {
        ...
        scope.basisCard('ground.path-coupling', 'relation', 'path relation that sends light, fluid, body, or signal through a curve or channel', {
        ...
        scope.basisCard('ground.force-coupling', 'relation', 'force relation where source acts on target through contact, field, or actuator', {
        ...
        scope.basisCard('ground.orbital-motion', 'relation', 'curved or orbital motion around center with gravity or angular constraint', {
        ...
        scope.basisCard('ground.pressure-membrane', 'component', 'elastic membrane enclosing gas or fluid pressure', {
        ...
        scope.basisCard('ground.membrane-structure', 'component', 'fabric or membrane structure with supports, wind load, and deflection', {
        ...
        scope.basisCard('ground.rigid-chain', 'component', 'chain of rigid blocks with sequential contact and tipping', {
        ...
        scope.basisCard('ground.biological-tissue', 'class', 'organ or tissue reduced to soft matter, membranes, flow, and reaction fields', {
        ...
        scope.basisCard('ground.household-object', 'component', 'household object reduced to rigid shell, contact, containment, heat, or flow', {
        ...
        scope.basisCard('ground.infrastructure-system', 'composition', 'built infrastructure reduced to structures, service networks, loads, flows, and ledgers', {
        ...
        scope.basisCard('ground.play-physics', 'component', 'sport or play object lowered to contact, elasticity, rotation, drag, and constraints', {
        ...
        scope.basisCard('ground.natural-environment', 'scene', 'natural environment reduced to terrain, atmosphere, water, materials, growth, and weather', {
        ...
        scope.basisCard('ground.operations-scene', 'scene', 'built operations scene reduced to spaces, agents, queues, vehicles, sensors, and service flows', {
        ...
        scope.basisCard('ground.space-phenomenon', 'scene', 'space phenomenon reduced to gravity, radiation, plasma, orbit paths, rock, and fields', {
        ...
        scope.basisCard('ground.material-sample', 'material', 'recognized material reduced to phase, density, contact, heat, chemistry, and field response', {
        ...
        scope.basisCard('ground.generic-event', 'event', 'generic process lowered through event operators for state, force, field, flow, or wave change', {
        ...
        scope.basisCard('ground.generic-relation', 'relation', 'generic relation lowered to spatial, support, path, field, thermal, or force coupling', {
    ...
    root.SimulattePhaseModuleRegistry.define('semanticRag', 'simulatte-semantic-rag-retrieval.js', {
