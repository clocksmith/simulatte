(function attachSimulattePhysicsModel(root) {
  ...
  let api;
    ...
    createRenderInvocation: scope.createRenderInvocation,
    createAuthoredPhaseResources: scope.createAuthoredPhaseResources,
    runAuthoredPhase: scope.runAuthoredPhase,
