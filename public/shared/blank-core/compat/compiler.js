...
(function attach(root, factory) {
  ...
  const api = factory((common ? require('./phase-contracts.js') : root.SimulattePhaseContracts), (common ? require('./pipeline-adapter.js') : root.SimulattePipelineRunner));
  if (common) module.exports = api;
  else root.SimulatteCompilerCore = api;
})(typeof globalThis !== 'undefined' ? globalThis : window, function createPhaseRunnerApi(contracts, pipelines) {
