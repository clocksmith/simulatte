...
(function attach(root, factory) {
  ...
  const api = factory((common ? require('./world-spec.js') : root.SimulatteWorldSpec), (common ? require('./data-world-spec.js') : root.SimulatteDataWorldSpec), (common ? require('./input-source.js') : root.SimulatteInputSource), (common ? require('./point-motion.js') : root.SimulattePointMotion), (common ? require('./pipeline-adapter.js') : root.SimulattePipelineRunner));
  if (common) module.exports = api;
  else root.SimulatteDataRun = api;
