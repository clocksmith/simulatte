(function attachAutonomyDataContractValidator(root, factory) {
  ...
  function validateManifest(manifest, ErrorType = DataContractError) {
    ...
    const keys = ['world', 'policy', 'featureCatalog', 'occurrenceCatalog', 'rerankerEvidence', 'regionRegistry', 'placeEmbeddingIndex', 'placeResolutionEvidence', 'modelRuntimeLock', 'pipelineModelSelection', 'applicationProfile', 'safetyHistoryIndex', 'curriculum', 'policyArenaEvidence'];
    keys.forEach((key) => {
