(function attachWorldTiersBoot(root, factory) {
  ...
  const appShell = typeof module === 'object' && module.exports ? require('./app-shell.js') : root.SimulatteAppShell;
  const api = factory(root, lifecycle, tierRegistry, experiencePresentation, appShell);
  root.SimulatteWorldTiersBoot = api;
  if (typeof module === 'object' && module.exports) module.exports = api;
})(typeof globalThis !== 'undefined' ? globalThis : window, function createWorldTiersBoot(root, lifecycleApi, tierRegistry, experiencePresentationApi, appShellApi) {
  if (!appShellApi) throw new Error('world_tiers_boot_app_shell_missing');
