(function attachSimulatteWorldRuntimeScriptManifest(root, factory) {
  ...
  const browser = Object.freeze([
    ...
    'shared/plugins/gpu-supercluster/workload.js',
    ...
    'simulatte/app/tier-scene-renderer.js',
    'simulatte/app/camera-fit.js',
    'simulatte/app/cluster-interaction.js',
    ...
    'simulatte/app/route-runtime.js',
  ...
  const cityRuntime = Object.freeze([
    'neural-model-consent.js',
    'model-selection.js',
    'shared/render/mesh-library.js',
    'shared/language/positive-language.js',
  ...
  const governedRuntime = Object.freeze([
    'simulatte/app/tier-run-controller.js',
    'simulatte/platform/bootstrap/tier-application-loader.js',
  ]);
  const profileDependencies = Object.freeze({
    'asteroid-defense-v1': Object.freeze(['shared/core/simulation/n-body-propagation.js']),
  });
  function runtimeForSelection(options = {}) {
    const tierId = options.tierId;
    if (!Object.hasOwn(TIER_DEFAULT_PROFILE, tierId)) {
      throw new Error(`world_runtime_tier_unknown: ${tierId}`);
    }
    const profileId = options.profileId || TIER_DEFAULT_PROFILE[tierId];
    return Object.freeze([...new Set([
      ...navigation,
      ...sharedRuntime,
      ...(tierId === 'city' ? cityRuntime : governedRuntime),
      ...(profileDependencies[profileId] || []),
    ])]);
  }
