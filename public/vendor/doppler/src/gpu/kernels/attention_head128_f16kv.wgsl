// Fused Multi-Head Attention Kernel (head_dim 128, f16 KV)
//
// Fixed-shape prefill kernel for 128-dim heads. It reuses one shared 128-dim
// block for K and then V so the workgroup avoids the repeated 32-wide tiling
