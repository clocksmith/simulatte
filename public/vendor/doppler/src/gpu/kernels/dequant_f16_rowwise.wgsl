// Q4_K Dequantization Kernel - f16 Output, Row-Wise Matrix Layout
//
// Dequantizes Q4_K blocks to f16 with proper row-major matrix stride.
...
fn main(
    ...
    // Write with proper row-major stride
