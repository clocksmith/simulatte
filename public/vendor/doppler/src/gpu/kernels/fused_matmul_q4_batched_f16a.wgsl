// Fused Q4_K Matmul Kernel - W4A16 (F16 activations, F16 output, batched)
//
// Batched version for prefill (M > 1) with f16 activations and f16 output.
