(function activationCloudModule(root, factory) {
  ...
  const LANGUAGE_VISUAL_SIGNAL_RULES = Object.freeze([
    ...
    signalRule('biological', 'biological operator signal', /\b(grow|grows|growing|growth|cell|protein|root|coral|algae|mycelium|membrane|neuron|tissue|microbiome|microbe|enzyme|ferment|fermentation|yeast|sourdough|gluten|dough)\b/, ['growth', 'diffusion', 'density'], ['branching-network', 'membrane-sheet', 'cell-cluster'], ['density', 'nutrient']),
