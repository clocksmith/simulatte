  ...
  const EXAMPLE_INTENTS = Object.freeze([
    {
      id: 'lava-turbine',
      label: 'W',
      prompt: 'lava spins turbine into ice wall',
      params: {
        flowRate: 0.86,
        heatTransfer: 0.92,
        viscosity: 0.58,
        turbineCoupling: 0.88,
        latentHeat: 0.62,
        hardness: 0.68,
        damping: 0.07,
      },
    },
    {
      id: 'fracture-tower',
      label: 'X',
      prompt: 'projectile cracks glass tower',
      params: {
        energyInput: 0.92,
        hardness: 0.34,
        restitution: 0.82,
    ...
    },
    {
      id: 'storm-bridge',
      label: 'Y',
      prompt: 'storm waves flex bridge cables',
      params: {
        waveAmplitude: 0.78,
        soundFrequency: 0.66,
        pressure: 0.74,
    ...
    },
    {
      id: 'queue-feedback',
      label: 'Z',
      prompt: 'market queue feedback shock',
      params: {
        queueBacklog: 0.82,
        serviceRate: 0.36,
        marketDemand: 0.86,
    ...
    },
    {
      id: 'basalt-delta',
      label: 'P',
      prompt: 'rain carves basalt delta',
      params: {
        flowRate: 0.9,
        erosionRate: 0.68,
        terrainSlope: 0.62,
        gravity: 0.22,
        granularFriction: 0.44,
        moisture: 0.82,
      },
    },
    {
      id: 'wetland-growth',
      label: 'Q',
      prompt: 'algae grows in quartz wetland',
      params: {
