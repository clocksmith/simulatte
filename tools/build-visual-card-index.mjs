...
visual.scene.protoplanetary-disk.silicate-dust.accrete.around.young-star.wide-establishing-view|Protoplanetary disk|Silicate dust|Accretion|Around|Volumetric 3D disk of silicate dust spiraling around a young star with orbital streamlines glowing pressure knots and embedded planetesimal wakes
visual.process.neutron-star-crust.iron-lattice.fracture.under.magnetic-stress.cutaway-section|Neutron star crust|Iron lattice|Starquake fracture|Under|Cutaway 3D neutron star crust where iron lattice plates shear under magnetic stress with gamma burst trigger bands and fault energy contours
...
visual.scene.cosmic-web.dark-matter.cluster.along.galaxy-filaments.deep-space-render|Cosmic web|Dark matter field|Clustering|Along|Large scale 3D cosmic web with dark matter density filaments galaxies as tracer particles and gravitational potential wells
visual.material.europa-ice-shell.salty-ice.fracture.over.hidden-ocean.cutaway-section|Europa ice shell|Salty ice|Fracture|Over|3D cutaway of salty ice shell cracking above a hidden ocean with tidal stress arrows melt pockets and brine channels
visual.process.martian-dust.perchlorate-ice.sublimate.under.ultraviolet-wind.topographic-map|Martian dust plain|Perchlorate ice|Sublimation|Under|Volumetric Mars regolith scene with perchlorate ice sublimating under ultraviolet wind and dust streamers over terrain ridges
visual.scene.venus-cloud-deck.sulfuric-acid.convect.around.superheated-atmosphere.wide-establishing-view|Venus cloud deck|Sulfuric acid droplets|Convection|Around|3D sulfuric acid cloud layers circulating through a superheated atmosphere with pressure bands and thermal plume columns
visual.composition.saturn-ring-system.ice-grains.shear.between.shepherd-moons.instrumented-space-view|Saturn ring system|Ice grains|Shear|Between|Instrumented 3D Saturn ring particles shearing between shepherd moons with resonance lanes collision flashes and density waves
visual.process.lunar-shadow-crater.water-ice.sublimate.inside.permanent-shadow.cutaway-section|Lunar shadow crater|Water ice|Sublimation|Inside|3D lunar crater cutaway where water ice sublimates slowly inside permanent shadow with temperature probes and vapor trace lines
visual.scene.solar-corona.hydrogen-plasma.reconnect.over.magnetic-loop.cinematic-volume|Solar corona|Hydrogen plasma|Magnetic reconnection|Over|Cinematic 3D solar corona with hydrogen plasma loops reconnecting above the photosphere and releasing thermal energy ribbons
visual.material.tokamak-core.deuterium-tritium-plasma.confine.inside.magnetic-bottle.instrumented-lab-view|Tokamak core|Deuterium tritium plasma|Magnetic confinement|Inside|3D tokamak plasma confined inside a magnetic bottle with toroidal field lines particle density shells and heat exhaust probes
visual.process.ion-thruster.xenon-plasma.accelerate.through.electric-grid.macro-inspection|Ion thruster|Xenon plasma|Acceleration|Through|Close 3D ion thruster plume where xenon plasma accelerates through electric grids with charge density maps and exhaust cones
visual.scene.magnetosphere.solar-wind-plasma.deflect.around.planetary-field.wide-establishing-view|Planetary magnetosphere|Solar wind plasma|Deflection|Around|3D magnetosphere deflecting solar wind plasma around a planet with bow shock shell auroral current paths and field topology
visual.composition.aurora-curtain.oxygen-nitrogen-plasma.cascade.down.magnetic-field-lines.cinematic-volume|Aurora curtain|Oxygen nitrogen plasma|Electron cascade|Down|Volumetric 3D aurora curtain falling down magnetic field lines with altitude color bands and particle precipitation cones
visual.scene.supercell-storm.humid-air.convect.inside.rotating-updraft.meteorological-radar-view|Supercell storm|Humid air|Convection|Inside|3D supercell storm with humid air convecting inside a rotating updraft radar slices charge layers and rain curtains
visual.process.hurricane-eyewall.sea-spray-aerosol.spin.around.low-pressure-core.topographic-map|Hurricane eyewall|Sea spray aerosol|Cyclonic spin|Around|3D hurricane eyewall spinning around a low pressure core with spray flux arrows warm ocean coupling and spiral rainbands
visual.composition.polar-vortex.ice-crystals.shear.between.jet-stream-layers.atmospheric-section|Polar vortex|Ice crystals|Shear|Between|Atmospheric 3D section where ice crystals shear between jet stream layers with temperature isosurfaces and wind vectors
visual.scene.urban-heat-island.concrete-air.heat.over.street-canyon.system-diagram|Urban heat island|Concrete and air|Heat accumulation|Over|3D street canyon heat island showing hot concrete surfaces thermal plumes shaded cool pockets and airflow recirculation
visual.process.cloud-microphysics.water-droplets.condense.around.aerosol-particles.macro-inspection|Cloud microphysics cell|Water droplets|Condensation|Around|Macro 3D cloud cell where droplets condense around aerosol particles with supersaturation shells and collision coalescence paths
visual.material.lightning-channel.ionized-air.discharge.through.storm-cell.cinematic-volume|Lightning channel|Ionized air|Discharge|Through|Cinematic 3D lightning channel discharging through a storm cell with branching electric fields and shockwave rings
visual.scene.hydrothermal-vent-field.brine-plume.crystallize.around.black-smoker.cutaway-section|Hydrothermal vent field|Brine plume|Crystallization|Around|3D seafloor vent where brine plume crystallizes around black smoker chimneys with mineral precipitation and turbulent mixing
visual.process.submarine-canyon.sediment-slurry.flow.down.slope.topographic-map|Submarine canyon|Sediment slurry|Gravity flow|Down|3D submarine canyon with sediment slurry flowing downslope in turbidity currents and depositing graded layers
visual.composition.kelp-forest.salt-water.shear.through.flexible-fronds.underwater-view|Kelp forest|Salt water|Shear flow|Through|3D underwater kelp forest where salt water shear passes through flexible fronds with wake vortices and nutrient gradients
visual.scene.wave-tank.oil-water.separate.into.layered-fluids.instrumented-lab-view|Wave tank|Oil water mixture|Phase separation|Into|Instrumented 3D wave tank where oil and water separate into layered fluids under sloshing waves and interface tension probes
visual.material.deep-sea-brine-pool.dense-brine.diffuse.across.halocline.cutaway-section|Deep sea brine pool|Dense brine|Diffusion|Across|3D brine pool with dense brine diffusing across a halocline boundary and toxic edge gradients along the seafloor
visual.process.river-delta.silt-water.sediment.along.branching-channels.topographic-map|River delta|Silt water|Sedimentation|Along|3D river delta where silt water sediments along branching channels with distributary growth and shoreline migration
visual.scene.glacier-terminus.blue-ice.fracture.into.ocean-front.cinematic-volume|Glacier terminus|Blue ice|Calving fracture|Into|3D glacier terminus where blue ice fractures into an ocean front with crevasse propagation and splash wave fields
visual.composition.volcanic-lahar.ash-mud.flow.through.valley-channel.topographic-map|Volcanic lahar|Ash mud|Debris flow|Through|3D volcanic lahar carrying ash mud through a valley channel with boulder pulses levees and runout zones
visual.scene.subduction-zone.basalt-slab.sink.under.continental-crust.cutaway-section|Subduction zone|Basalt slab|Sinking|Under|3D geologic cutaway where a basalt slab sinks under continental crust with mantle wedge melting and earthquake rupture planes
visual.process.fault-system.granite-blocks.slip.along.strike-slip-plane.instrumented-section|Fault system|Granite blocks|Slip|Along|3D fault system with granite blocks slipping along a strike slip plane seismic wavefronts and stress tensor glyphs
visual.material.crystal-cavern.quartz.grow.from.supersaturated-solution.macro-inspection|Crystal cavern|Quartz|Crystal growth|From|Macro 3D cavern where quartz grows from supersaturated solution with faceted growth fronts and impurity color bands
visual.scene.karst-aquifer.limestone-water.erode.through.cave-network.cutaway-section|Karst aquifer|Limestone and water|Erosion|Through|3D karst aquifer cutaway where limestone dissolves into cave networks with groundwater paths and collapse hazards
...
visual.composition.magma-chamber.molten-basalt.convect.inside.crustal-reservoir.cutaway-section|Magma chamber|Molten basalt|Convection|Inside|3D magma chamber with molten basalt convecting inside a crustal reservoir and crystallizing along cooler margins
visual.scene.coil-bench.copper-wire.induce-current.around.iron-core.instrumented-lab-view|Coil bench|Copper wire|Current induction|Around|3D electromagnetic bench where copper wire induces current around an iron core with field lines heat tint and oscilloscope traces
visual.process.ferrofluid-dish.black-ferrofluid.spike.under.magnetic-array.macro-inspection|Ferrofluid dish|Black ferrofluid|Spike formation|Under|Macro 3D ferrofluid dish forming spikes under a magnetic array with surface tension ridges and flux density contours
visual.composition.motor-airgap.magnetized-steel.rotate.between.stator-and-rotor.cutaway-section|Motor airgap|Magnetized steel|Rotation|Between|3D motor cutaway where magnetized steel rotates between stator and rotor with torque vectors eddy currents and thermal loss bands
visual.scene.antenna-range.radio-field.radiate.from.phased-array.system-diagram|Antenna range|Radio field|Radiation|From|3D antenna range showing radio field radiation from a phased array with beam steering lobes and interference nulls
visual.material.plasma-arc.ionized-gas.bridge.between.electrodes.cinematic-volume|Plasma arc|Ionized gas|Arc bridging|Between|Cinematic 3D plasma arc bridging electrodes with bright core sheath regions magnetic pinch and heat distortion
visual.process.semiconductor-wafer.electron-hole-pairs.diffuse.across.pn-junction.macro-inspection|Semiconductor wafer|Electron hole pairs|Diffusion|Across|Macro 3D pn junction with electron hole pairs diffusing across depletion layers and potential contours
visual.scene.laser-table.coherent-light.focus.through.lens-train.instrumented-lab-view|Laser table|Coherent light|Focusing|Through|3D laser table with coherent light focusing through a lens train beam waists caustic cones and alignment rails
visual.composition.fiber-junction.photons.refract.along.glass-core.cutaway-section|Fiber junction|Photons|Refraction|Along|3D fiber optic cutaway where photons refract along a glass core with dispersion colors and cladding boundary reflections
visual.material.thin-film-soap.surface-film.interfere.across.wire-loop.macro-inspection|Thin film soap loop|Surface film|Interference|Across|Macro 3D soap film where surface film interference creates rainbow phase bands across a wire loop and rupture seeds
visual.process.mirror-swarm.sunlight.reflect.onto.algae-pond.wide-establishing-view|Mirror swarm|Sunlight|Reflection|Onto|3D orbital mirror swarm reflecting sunlight onto an algae pond with tracking arcs energy density spot and thermal bloom
visual.scene.photonic-crystal.lattice-glass.filter.through.bandgap-structure.cutaway-section|Photonic crystal|Lattice glass|Filtering|Through|3D photonic crystal filtering light through bandgap structure with periodic cells forbidden modes and spectral output
visual.composition.prism-bench.white-light.disperse.into.spectral-fan.instrumented-lab-view|Prism bench|White light|Dispersion|Into|3D prism bench where white light disperses into a spectral fan with refractive index labels and ray geometry
visual.scene.brass-tube-resonator.air-column.resonate.inside.tube-cutaway.instrumented-lab-view|Brass tube resonator|Air column|Resonance|Inside|3D brass tube cutaway where air column resonance traps dust at pressure nodes and antinode shells
visual.process.ultrasound-bath.gel-phantom.oscillate.through.pressure-field.macro-inspection|Ultrasound bath|Gel phantom|Oscillation|Through|Macro 3D ultrasound bath with gel phantom oscillating through pressure fields cavitation pockets and standing wave planes
visual.composition.concert-hall.sound-waves.reflect.around.stage-shell.system-diagram|Concert hall|Sound waves|Reflection|Around|3D concert hall acoustics showing sound waves reflecting around a stage shell with early reflections and audience absorption zones
visual.material.seismic-basin.rock-layers.vibrate.under.surface-wave.cutaway-section|Seismic basin|Rock layers|Vibration|Under|3D seismic basin where rock layers vibrate under a surface wave with impedance boundaries and amplified motion zones
visual.scene.granular-levitator.dust-particles.levitate.between.acoustic-nodes.macro-inspection|Granular levitator|Dust particles|Levitation|Between|Macro 3D dust particles levitating between acoustic nodes with pressure shells drag wakes and sorting lanes
visual.process.memristor-crossbar.oxide-filament.switch.through.nano-junction.macro-inspection|Memristor crossbar|Oxide filament|Switching|Through|Macro 3D memristor crossbar where oxide filaments switch through nano junctions with current density and thermal hotspots
visual.scene.quantum-dot-lattice.electron-cloud.tunnel.between.potential-wells.nano-scale-view|Quantum dot lattice|Electron cloud|Tunneling|Between|3D nano scale quantum dot lattice showing electron cloud tunneling between potential wells with probability density shells
visual.material.graphene-sheet.carbon-lattice.conduct.across.two-dimensional-plane.macro-inspection|Graphene sheet|Carbon lattice|Conduction|Across|Macro 3D graphene sheet with carbon lattice conduction across a two dimensional plane and Dirac cone overlays
visual.composition.ion-trap-row.charged-ions.oscillate.inside.laser-cooling-field.instrumented-lab-view|Ion trap row|Charged ions|Oscillation|Inside|3D ion trap row with charged ions oscillating inside laser cooling fields and phonon mode arrows
visual.process.molecular-motor.protein-gel.walk.along.microtubule-track.macro-inspection|Molecular motor|Protein gel|Walking|Along|Macro 3D molecular motor walking along microtubule track with ATP pulses conformational states and cargo load vector
visual.scene.nanopore-sensor.dna-strand.translocate.through.ionic-channel.macro-inspection|Nanopore sensor|DNA strand|Translocation|Through|Macro 3D nanopore sensor where DNA strand translocates through ionic channel with current trace and base dwell timing
visual.material.protein-fold.amino-acid-chain.fold.into.binding-pocket.molecular-dynamics-simulation|Protein fold|Amino acid chain|Folding|Into|3D molecular dynamics protein fold where amino acid chain folds into a binding pocket with hydrophobic collapse and contact maps
visual.process.heart-valve.blood-flow.pump.through.flexible-leaflets.cutaway-section|Heart valve|Blood flow|Pumping|Through|3D heart valve cutaway where blood flow pumps through flexible leaflets with vortices pressure gradients and closure dynamics
visual.scene.lung-airway-tree.humid-air.breathe.through.branching-bronchi.anatomical-volume|Lung airway tree|Humid air|Breathing|Through|3D anatomical airway tree with humid air breathing through branching bronchi and particle deposition heat maps
visual.composition.joint-cartilage.synovial-fluid.lubricate.between.bone-surfaces.macro-inspection|Joint cartilage|Synovial fluid|Lubrication|Between|Macro 3D joint cartilage where synovial fluid lubricates between bone surfaces under compressive load and contact stress
visual.material.muscle-tendon.collagen-fibers.stretch.along.force-axis.cutaway-section|Muscle tendon|Collagen fibers|Stretching|Along|3D tendon cutaway with collagen fibers stretching along force axis and strain bands across fascicles
visual.process.brain-network.ion-current.propagate.along.axon-bundles.microscopic-flux-plot|Brain network|Ion current|Propagation|Along|3D neural network with ion current propagating along axon bundles synaptic delays and field potential pulses
visual.scene.biofilm-reactor.nutrient-gel.diffuse.through.microbial-mat.macro-inspection|Biofilm reactor|Nutrient gel|Diffusion|Through|Macro 3D biofilm reactor where nutrient gel diffuses through microbial mat with growth fronts and oxygen gradients
...
visual.process.algae-photobioreactor.green-biomass.photosynthesize.under.led-spectrum.instrumented-lab-view|Algae photobioreactor|Green biomass|Photosynthesis|Under|3D algae photobioreactor where green biomass photosynthesizes under LED spectrum with CO2 bubbles and oxygen output readouts
visual.scene.gut-colony.short-chain-fatty-acids.ferment.inside.mucus-channel.microscopic-flux-plot|Gut colony channel|Short chain fatty acids|Fermentation|Inside|3D gut microcolony fermentation inside mucus channel with substrate gradients microbial layers and epithelial uptake arrows
visual.material.cell-membrane.lipid-bilayer.transport.across.ion-channel.macro-inspection|Cell membrane|Lipid bilayer|Transport|Across|Macro 3D lipid bilayer where ions transport across membrane channels with gating states and electrochemical potential
visual.process.embryo-gastrulation.cell-sheet.fold.into.body-axis.molecular-dynamics-simulation|Embryo gastrulation|Cell sheet|Folding|Into|3D embryo gastrulation with cell sheet folding into body axis traction vectors morphogen gradients and lineage color fields
visual.scene.reaction-vessel.acid-base-solution.react.inside.stirred-tank.instrumented-lab-view|Reaction vessel|Acid base solution|Reaction|Inside|3D stirred tank where acid base solution reacts inside vessel with pH gradients heat plume and mixing vortices
visual.material.crystal-growth-tray.salt-solution.crystallize.from.seed-lattice.macro-inspection|Crystal growth tray|Salt solution|Crystallization|From|Macro 3D salt solution crystallizing from seed lattice with supersaturation shells and faceted growth surfaces
visual.process.corrosion-cell.steel-electrolyte.corrode.across.anode-cathode.surface.macro-inspection|Corrosion cell|Steel electrolyte|Corrosion|Across|Macro 3D corrosion cell where steel electrolyte corrodes across anode cathode surfaces with pits and current paths
visual.composition.polymer-curing-mold.resin-gel.solidify.inside.cast-form.cutaway-section|Polymer curing mold|Resin gel|Solidification|Inside|3D cast mold where resin gel solidifies inside form with cure front heat release and shrinkage stress
visual.scene.catalyst-bed.gas-mixture.react.through.porous-pellets.cutaway-section|Catalyst bed|Gas mixture|Catalytic reaction|Through|3D catalyst bed where gas mixture reacts through porous pellets with concentration boundary layers and heat spots
visual.process.electrolysis-cell.water-ions.split.between.electrodes.instrumented-lab-view|Electrolysis cell|Water ions|Splitting|Between|3D electrolysis cell where water ions split between electrodes with hydrogen bubbles oxygen plume and voltage field
visual.material.battery-separator.lithium-ions.diffuse.through.polymer-membrane.macro-inspection|Battery separator|Lithium ions|Diffusion|Through|Macro 3D battery separator where lithium ions diffuse through polymer membrane with dendrite risk zones and concentration maps
visual.scene.kiln-room.porcelain.sinter.inside.radiant-chamber.instrumented-lab-view|Kiln room|Porcelain|Sintering|Inside|3D kiln chamber where porcelain sinters inside radiant heat field with shrinkage cracks glaze flow and humidity traces
visual.process.forge-cell.molten-steel.weld.along.seam-line.cinematic-volume|Forge cell|Molten steel|Welding|Along|Cinematic 3D forge cell with molten steel welding along seam line arc plasma sparks and heat affected zones
visual.composition.textile-loom.carbon-fiber.weave.across.tensioned-frame.cutaway-section|Textile loom|Carbon fiber|Weaving|Across|3D textile loom where carbon fiber weaves across a tensioned frame with over under path and anisotropic stiffness arrows
visual.material.additive-printer-bed.ceramic-powder.sinter.under.laser-scan.macro-inspection|Additive printer bed|Ceramic powder|Laser sintering|Under|Macro 3D printer bed with ceramic powder sintering under laser scan path and melt pool thermal gradient
visual.scene.flywheel-vault.magnet-steel.spin.inside.vacuum-chamber.cutaway-section|Flywheel vault|Magnet steel|Spin|Inside|3D flywheel vault where magnet steel spins inside vacuum chamber with bearing fields hoop stress and stored energy readouts
visual.process.hydrogen-electrolyzer.water-gas-bubbles.separate.through.membrane-stack.instrumented-lab-view|Hydrogen electrolyzer|Water gas bubbles|Separation|Through|3D electrolyzer where water gas bubbles separate through membrane stack with ion flow and pressure equalization
visual.composition.molten-salt-battery.graphite-foam.breathe.through.porous-electrode.cutaway-section|Molten salt battery|Graphite foam|Porous breathing|Through|3D molten salt battery where graphite foam breathes through porous electrode with salt circulation heat bands and charge paths
visual.material.thermal-storage-tank.phase-change-salt.melt.inside.insulated-vessel.cutaway-section|Thermal storage tank|Phase change salt|Melting|Inside|3D thermal storage tank where phase change salt melts inside insulated vessel with latent heat front and coil exchanger
visual.scene.power-substation.copper-busbar.heat.under.load-surge.system-diagram|Power substation|Copper busbar|Heating|Under|3D power substation where copper busbar heats under load surge with breaker states transformer oil flow and fault paths
visual.process.subway-tunnel-grid.human-agents.queue.at.platform-edge.dynamic-motion-trace|Subway tunnel grid|Human agents|Queueing|At|3D subway station with human agents queueing at platform edge route constraints train arrivals and density pressure maps
visual.composition.traffic-interchange.vehicle-streams.reroute.between.blocked-links.topographic-map|Traffic interchange|Vehicle streams|Rerouting|Between|3D traffic interchange where vehicle streams reroute between blocked links with queue spillback and signal timing overlays
visual.scene.water-treatment-plant.chlorinated-water.pump.through.filter-beds.cutaway-section|Water treatment plant|Chlorinated water|Pumping|Through|3D water treatment plant where chlorinated water pumps through filter beds with turbidity gradients and valve states
visual.material.shipping-port.cargo-containers.jam.around.crane-queue.system-diagram|Shipping port|Cargo containers|Queue jam|Around|3D shipping port where cargo containers jam around crane queue with berth schedules and route bottlenecks
visual.process.hospital-triage.human-agents.balance.between.service-desks.dynamic-motion-trace|Hospital triage|Human agents|Load balancing|Between|3D hospital triage where human agents balance between service desks with wait-time contours and resource constraints
visual.scene.market-floor.paper-orders.queue.through.matching-engine.system-diagram|Market floor|Paper orders|Queueing|Through|3D market floor abstraction where paper orders queue through a matching engine with liquidity pools and price wavefronts
visual.composition.stadium-exit.crowd-flow.diffuse.through.gate-network.topographic-map|Stadium exit|Crowd flow|Diffusion|Through|3D stadium exit where crowd flow diffuses through gate network with density waves obstacles and safety margins
visual.scene.vertical-farm.leaf-tissue.photosynthesize.under.led-rack.instrumented-lab-view|Vertical farm|Leaf tissue|Photosynthesis|Under|3D vertical farm rack with leaf tissue photosynthesizing under LED spectrum nutrient flow mist and growth rate readouts
visual.process.irrigated-field.wet-soil.diffuse.across.root-zone.topographic-map|Irrigated field|Wet soil|Diffusion|Across|3D irrigated field where wet soil diffusion crosses root zones with emitter patterns salinity fronts and plant uptake
visual.material.fermentation-vat.yeast-foam.react.inside.sugar-broth.cutaway-section|Fermentation vat|Yeast foam|Fermentation|Inside|3D fermentation vat where yeast foam reacts inside sugar broth with CO2 bubbles heat release and concentration gradients
visual.composition.grain-silo.corn-kernels.flow.through.discharge-hopper.cutaway-section|Grain silo|Corn kernels|Granular flow|Through|3D grain silo with corn kernels flowing through discharge hopper arching zones friction cones and avalanche sheets
visual.scene.forest-canopy.water-vapor.recycle.over.leaf-layers.atmospheric-section|Forest canopy|Water vapor|Evapotranspiration|Over|3D forest canopy where water vapor recycles over leaf layers with stomata flux and cloud feedback streamlines
visual.process.coral-reef.calcium-carbonate.grow.around.wave-exposed-colony.underwater-view|Coral reef|Calcium carbonate|Growth|Around|3D coral reef where calcium carbonate grows around wave exposed colony with pH stress bands and fish flow paths
visual.material.wetland-marsh.methane-bubbles.release.through.mud-root-mat.cutaway-section|Wetland marsh|Methane bubbles|Release|Through|3D wetland marsh where methane bubbles release through mud root mat with redox layers and microbial production pockets
visual.composition.beehive.wax-comb.swarm.around.thermal-cluster.macro-inspection|Beehive|Wax comb|Swarming|Around|3D beehive wax comb with bees swarming around a thermal cluster airflow paths and brood heat map
visual.scene.ant-colony.soil-grains.transport.along.tunnel-network.cutaway-section|Ant colony|Soil grains|Transport|Along|3D ant colony cutaway where soil grains transport along tunnel network with pheromone trails traffic jams and chamber loads
visual.process.mycorrhizal-network.phosphate-ions.exchange.between.root-and-fungus.microscopic-flux-plot|Mycorrhizal network|Phosphate ions|Exchange|Between|3D mycorrhizal network exchanging phosphate ions between root and fungus with hyphae branches and nutrient accounting
visual.material.seaweed-farm.algae-strands.grow.along.wave-current.underwater-view|Seaweed farm|Algae strands|Growth|Along|3D seaweed farm where algae strands grow along wave current with drag bending nutrient uptake and harvest lanes
visual.scene.fire-ecology.charred-wood.regrow.from.seed-bank.topographic-map|Fire ecology plot|Charred wood|Regrowth|From|3D postfire ecology scene where charred wood regrows from seed bank with nutrient pulses erosion risk and canopy recovery`;
