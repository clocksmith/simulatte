...
const visualOperatorAtlas = require(path.join(ROOT, 'public/blank/pipeline/phase-06-visual/simulatte-visual-operator-atlas.js'));
const OUT_DIR = path.join(ROOT, 'public/data/simulatte-visual-cards');
...
visual.scene.protoplanetary-disk.silicate-dust.accrete.around.wide-establishing-view|Protoplanetary disk|Silicate dust|Accretion|Around|Volumetric 3D disk of silicate dust spiraling around a young star with orbital streamlines glowing pressure knots and embedded planetesimal wakes
visual.process.neutron-star-crust.iron-lattice.fracture.under.cutaway-section|Neutron star crust|Iron lattice|Starquake fracture|Under|Cutaway 3D neutron star crust where iron lattice plates shear under magnetic stress with gamma burst trigger bands and fault energy contours
visual.composition.black-hole-accretion-plasma.radiate.around.event-horizon.cinematic-volume|Black hole accretion field|Relativistic plasma|Radiation|Around|Cinematic 3D accretion plasma wrapping an event horizon with lensing arcs photon rings and heat flux color bands
visual.scene.cosmic-web.dark-matter.cluster.along.deep-space-render|Cosmic web|Dark matter field|Clustering|Along|Large scale 3D cosmic web with dark matter density filaments galaxies as tracer particles and gravitational potential wells
visual.material.europa-ice-shell.salty-ice.fracture.over.cutaway-section|Europa ice shell|Salty ice|Fracture|Over|3D cutaway of salty ice shell cracking above a hidden ocean with tidal stress arrows melt pockets and brine channels
visual.process.martian-dust.perchlorate-ice.sublimate.under.topographic-map|Martian dust plain|Perchlorate ice|Sublimation|Under|Volumetric Mars regolith scene with perchlorate ice sublimating under ultraviolet wind and dust streamers over terrain ridges
visual.scene.venus-cloud-deck.sulfuric-acid.convect.around.wide-establishing-view|Venus cloud deck|Sulfuric acid droplets|Convection|Around|3D sulfuric acid cloud layers circulating through a superheated atmosphere with pressure bands and thermal plume columns
visual.composition.saturn-ring-system.ice-grains.shear.between.instrumented-space-view|Saturn ring system|Ice grains|Shear|Between|Instrumented 3D Saturn ring particles shearing between shepherd moons with resonance lanes collision flashes and density waves
visual.process.lunar-shadow-crater.water-ice.sublimate.inside.cutaway-section|Lunar shadow crater|Water ice|Sublimation|Inside|3D lunar crater cutaway where water ice sublimates slowly inside permanent shadow with temperature probes and vapor trace lines
visual.scene.solar-corona.hydrogen-plasma.reconnect.over.cinematic-volume|Solar corona|Hydrogen plasma|Magnetic reconnection|Over|Cinematic 3D solar corona with hydrogen plasma loops reconnecting above the photosphere and releasing thermal energy ribbons
visual.material.tokamak-core.deuterium-tritium-plasma.confine.inside.instrumented-lab-view|Tokamak core|Deuterium tritium plasma|Magnetic confinement|Inside|3D tokamak plasma confined inside a magnetic bottle with toroidal field lines particle density shells and heat exhaust probes
visual.process.ion-thruster.xenon-plasma.accelerate.through.macro-inspection|Ion thruster|Xenon plasma|Acceleration|Through|Close 3D ion thruster plume where xenon plasma accelerates through electric grids with charge density maps and exhaust cones
visual.scene.magnetosphere.solar-wind-plasma.deflect.around.wide-establishing-view|Planetary magnetosphere|Solar wind plasma|Deflection|Around|3D magnetosphere deflecting solar wind plasma around a planet with bow shock shell auroral current paths and field topology
visual.composition.aurora-curtain.oxygen-nitrogen-plasma.cascade.down.cinematic-volume|Aurora curtain|Oxygen nitrogen plasma|Electron cascade|Down|Volumetric 3D aurora curtain falling down magnetic field lines with altitude color bands and particle precipitation cones
visual.scene.supercell-storm.humid-air.convect.inside.meteorological-radar-view|Supercell storm|Humid air|Convection|Inside|3D supercell storm with humid air convecting inside a rotating updraft radar slices charge layers and rain curtains
visual.process.hurricane-eyewall.sea-spray-aerosol.spin.around.topographic-map|Hurricane eyewall|Sea spray aerosol|Cyclonic spin|Around|3D hurricane eyewall spinning around a low pressure core with spray flux arrows warm ocean coupling and spiral rainbands
visual.composition.polar-vortex.ice-crystals.shear.between.atmospheric-section|Polar vortex|Ice crystals|Shear|Between|Atmospheric 3D section where ice crystals shear between jet stream layers with temperature isosurfaces and wind vectors
visual.scene.urban-heat-island.concrete-air.heat.over.system-diagram|Urban heat island|Concrete and air|Heat accumulation|Over|3D street canyon heat island showing hot concrete surfaces thermal plumes shaded cool pockets and airflow recirculation
visual.process.cloud-microphysics.water-droplets.condense.around.macro-inspection|Cloud microphysics cell|Water droplets|Condensation|Around|Macro 3D cloud cell where droplets condense around aerosol particles with supersaturation shells and collision coalescence paths
visual.material.lightning-channel.ionized-air.discharge.through.cinematic-volume|Lightning channel|Ionized air|Discharge|Through|Cinematic 3D lightning channel discharging through a storm cell with branching electric fields and shockwave rings
visual.scene.hydrothermal-vent-field.brine-plume.crystallize.around.cutaway-section|Hydrothermal vent field|Brine plume|Crystallization|Around|3D seafloor vent where brine plume crystallizes around black smoker chimneys with mineral precipitation and turbulent mixing
visual.process.submarine-canyon.sediment-slurry.flow.down.topographic-map|Submarine canyon|Sediment slurry|Gravity flow|Down|3D submarine canyon with sediment slurry flowing downslope in turbidity currents and depositing graded layers
visual.composition.kelp-forest.salt-water.shear.through.underwater-view|Kelp forest|Salt water|Shear flow|Through|3D underwater kelp forest where salt water shear passes through flexible fronds with wake vortices and nutrient gradients
visual.scene.wave-tank.oil-water.separate.into.instrumented-lab-view|Wave tank|Oil water mixture|Phase separation|Into|Instrumented 3D wave tank where oil and water separate into layered fluids under sloshing waves and interface tension probes
visual.material.deep-sea-brine-pool.dense-brine.diffuse.across.cutaway-section|Deep sea brine pool|Dense brine|Diffusion|Across|3D brine pool with dense brine diffusing across a halocline boundary and toxic edge gradients along the seafloor
visual.process.river-delta.silt-water.sediment.along.topographic-map|River delta|Silt water|Sedimentation|Along|3D river delta where silt water sediments along branching channels with distributary growth and shoreline migration
visual.scene.glacier-terminus.blue-ice.fracture.into.cinematic-volume|Glacier terminus|Blue ice|Calving fracture|Into|3D glacier terminus where blue ice fractures into an ocean front with crevasse propagation and splash wave fields
visual.composition.volcanic-lahar.ash-mud.flow.through.topographic-map|Volcanic lahar|Ash mud|Debris flow|Through|3D volcanic lahar carrying ash mud through a valley channel with boulder pulses levees and runout zones
visual.scene.subduction-zone.basalt-slab.sink.under.cutaway-section|Subduction zone|Basalt slab|Sinking|Under|3D geologic cutaway where a basalt slab sinks under continental crust with mantle wedge melting and earthquake rupture planes
visual.process.fault-system.granite-blocks.slip.along.instrumented-section|Fault system|Granite blocks|Slip|Along|3D fault system with granite blocks slipping along a strike slip plane seismic wavefronts and stress tensor glyphs
visual.material.crystal-cavern.quartz.grow.from.macro-inspection|Crystal cavern|Quartz|Crystal growth|From|Macro 3D cavern where quartz grows from supersaturated solution with faceted growth fronts and impurity color bands
visual.scene.karst-aquifer.limestone-water.erode.through.cutaway-section|Karst aquifer|Limestone and water|Erosion|Through|3D karst aquifer cutaway where limestone dissolves into cave networks with groundwater paths and collapse hazards
visual.process.desert-dune.sand-saltate.over.windward-slope.topographic-map|Desert dune|Sand grains|Saltation|Over|3D desert dune where sand grains saltate over the windward slope with ripple formation and lee avalanche sheets
visual.composition.magma-chamber.molten-basalt.convect.inside.cutaway-section|Magma chamber|Molten basalt|Convection|Inside|3D magma chamber with molten basalt convecting inside a crustal reservoir and crystallizing along cooler margins
visual.scene.coil-bench.copper-wire.induce-current.around.instrumented-lab-view|Coil bench|Copper wire|Current induction|Around|3D electromagnetic bench where copper wire induces current around an iron core with field lines heat tint and oscilloscope traces
visual.process.ferrofluid-dish.black-ferrofluid.spike.under.macro-inspection|Ferrofluid dish|Black ferrofluid|Spike formation|Under|Macro 3D ferrofluid dish forming spikes under a magnetic array with surface tension ridges and flux density contours
visual.composition.motor-airgap.magnetized-steel.rotate.between.cutaway-section|Motor airgap|Magnetized steel|Rotation|Between|3D motor cutaway where magnetized steel rotates between stator and rotor with torque vectors eddy currents and thermal loss bands
visual.scene.antenna-range.radio-field.radiate.from.system-diagram|Antenna range|Radio field|Radiation|From|3D antenna range showing radio field radiation from a phased array with beam steering lobes and interference nulls
visual.material.plasma-arc.ionized-gas.bridge.between.cinematic-volume|Plasma arc|Ionized gas|Arc bridging|Between|Cinematic 3D plasma arc bridging electrodes with bright core sheath regions magnetic pinch and heat distortion
visual.process.semiconductor-wafer.electron-hole-pairs.diffuse.across.macro-inspection|Semiconductor wafer|Electron hole pairs|Diffusion|Across|Macro 3D pn junction with electron hole pairs diffusing across depletion layers and potential contours
visual.scene.laser-table.coherent-light.focus.through.instrumented-lab-view|Laser table|Coherent light|Focusing|Through|3D laser table with coherent light focusing through a lens train beam waists caustic cones and alignment rails
visual.composition.fiber-junction.photons.refract.along.cutaway-section|Fiber junction|Photons|Refraction|Along|3D fiber optic cutaway where photons refract along a glass core with dispersion colors and cladding boundary reflections
visual.material.thin-film-soap.surface-film.interfere.across.macro-inspection|Thin film soap loop|Surface film|Interference|Across|Macro 3D soap film where surface film interference creates rainbow phase bands across a wire loop and rupture seeds
visual.process.mirror-swarm.sunlight.reflect.onto.wide-establishing-view|Mirror swarm|Sunlight|Reflection|Onto|3D orbital mirror swarm reflecting sunlight onto an algae pond with tracking arcs energy density spot and thermal bloom
visual.scene.photonic-crystal.lattice-glass.filter.through.cutaway-section|Photonic crystal|Lattice glass|Filtering|Through|3D photonic crystal filtering light through bandgap structure with periodic cells forbidden modes and spectral output
visual.composition.prism-bench.white-light.disperse.into.instrumented-lab-view|Prism bench|White light|Dispersion|Into|3D prism bench where white light disperses into a spectral fan with refractive index labels and ray geometry
visual.scene.brass-tube-resonator.air-column.resonate.inside.instrumented-lab-view|Brass tube resonator|Air column|Resonance|Inside|3D brass tube cutaway where air column resonance traps dust at pressure nodes and antinode shells
visual.process.ultrasound-bath.gel-phantom.oscillate.through.macro-inspection|Ultrasound bath|Gel phantom|Oscillation|Through|Macro 3D ultrasound bath with gel phantom oscillating through pressure fields cavitation pockets and standing wave planes
visual.composition.concert-hall.sound-waves.reflect.around.system-diagram|Concert hall|Sound waves|Reflection|Around|3D concert hall acoustics showing sound waves reflecting around a stage shell with early reflections and audience absorption zones
visual.material.seismic-basin.rock-layers.vibrate.under.cutaway-section|Seismic basin|Rock layers|Vibration|Under|3D seismic basin where rock layers vibrate under a surface wave with impedance boundaries and amplified motion zones
visual.scene.granular-levitator.dust-particles.levitate.between.macro-inspection|Granular levitator|Dust particles|Levitation|Between|Macro 3D dust particles levitating between acoustic nodes with pressure shells drag wakes and sorting lanes
visual.process.memristor-crossbar.oxide-filament.switch.through.macro-inspection|Memristor crossbar|Oxide filament|Switching|Through|Macro 3D memristor crossbar where oxide filaments switch through nano junctions with current density and thermal hotspots
visual.scene.quantum-dot-lattice.electron-cloud.tunnel.between.nano-scale-view|Quantum dot lattice|Electron cloud|Tunneling|Between|3D nano scale quantum dot lattice showing electron cloud tunneling between potential wells with probability density shells
visual.material.graphene-sheet.carbon-lattice.conduct.across.macro-inspection|Graphene sheet|Carbon lattice|Conduction|Across|Macro 3D graphene sheet with carbon lattice conduction across a two dimensional plane and Dirac cone overlays
visual.composition.ion-trap-row.charged-ions.oscillate.inside.instrumented-lab-view|Ion trap row|Charged ions|Oscillation|Inside|3D ion trap row with charged ions oscillating inside laser cooling fields and phonon mode arrows
visual.process.molecular-motor.protein-gel.walk.along.macro-inspection|Molecular motor|Protein gel|Walking|Along|Macro 3D molecular motor walking along microtubule track with ATP pulses conformational states and cargo load vector
visual.scene.nanopore-sensor.dna-strand.translocate.through.macro-inspection|Nanopore sensor|DNA strand|Translocation|Through|Macro 3D nanopore sensor where DNA strand translocates through ionic channel with current trace and base dwell timing
visual.material.protein-fold.amino-acid-chain.fold.into.molecular-dynamics-simulation|Protein fold|Amino acid chain|Folding|Into|3D molecular dynamics protein fold where amino acid chain folds into a binding pocket with hydrophobic collapse and contact maps
visual.process.heart-valve.blood-flow.pump.through.cutaway-section|Heart valve|Blood flow|Pumping|Through|3D heart valve cutaway where blood flow pumps through flexible leaflets with vortices pressure gradients and closure dynamics
visual.scene.lung-airway-tree.humid-air.breathe.through.anatomical-volume|Lung airway tree|Humid air|Breathing|Through|3D anatomical airway tree with humid air breathing through branching bronchi and particle deposition heat maps
visual.composition.joint-cartilage.synovial-fluid.lubricate.between.macro-inspection|Joint cartilage|Synovial fluid|Lubrication|Between|Macro 3D joint cartilage where synovial fluid lubricates between bone surfaces under compressive load and contact stress
visual.material.muscle-tendon.collagen-fibers.stretch.along.cutaway-section|Muscle tendon|Collagen fibers|Stretching|Along|3D tendon cutaway with collagen fibers stretching along force axis and strain bands across fascicles
visual.process.brain-network.ion-current.propagate.along.microscopic-flux-plot|Brain network|Ion current|Propagation|Along|3D neural network with ion current propagating along axon bundles synaptic delays and field potential pulses
visual.scene.biofilm-reactor.nutrient-gel.diffuse.through.macro-inspection|Biofilm reactor|Nutrient gel|Diffusion|Through|Macro 3D biofilm reactor where nutrient gel diffuses through microbial mat with growth fronts and oxygen gradients
visual.composition.soil-microbiome.mycelium-grow.through.pore-network.cutaway-section|Soil microbiome|Mycelium|Growth|Through|3D soil pore cutaway with mycelium growing through pore network nutrient hotspots bacteria colonies and moisture channels
visual.process.algae-photobioreactor.green-biomass.photosynthesize.under.instrumented-lab-view|Algae photobioreactor|Green biomass|Photosynthesis|Under|3D algae photobioreactor where green biomass photosynthesizes under LED spectrum with CO2 bubbles and oxygen output readouts
visual.scene.gut-colony.short-chain-fatty-acids.ferment.inside.microscopic-flux-plot|Gut colony channel|Short chain fatty acids|Fermentation|Inside|3D gut microcolony fermentation inside mucus channel with substrate gradients microbial layers and epithelial uptake arrows
visual.material.cell-membrane.lipid-bilayer.transport.across.macro-inspection|Cell membrane|Lipid bilayer|Transport|Across|Macro 3D lipid bilayer where ions transport across membrane channels with gating states and electrochemical potential
visual.process.embryo-gastrulation.cell-sheet.fold.into.molecular-dynamics-simulation|Embryo gastrulation|Cell sheet|Folding|Into|3D embryo gastrulation with cell sheet folding into body axis traction vectors morphogen gradients and lineage color fields
visual.scene.reaction-vessel.acid-base-solution.react.inside.instrumented-lab-view|Reaction vessel|Acid base solution|Reaction|Inside|3D stirred tank where acid base solution reacts inside vessel with pH gradients heat plume and mixing vortices
visual.material.crystal-growth-tray.salt-solution.crystallize.from.macro-inspection|Crystal growth tray|Salt solution|Crystallization|From|Macro 3D salt solution crystallizing from seed lattice with supersaturation shells and faceted growth surfaces
visual.process.corrosion-cell.steel-electrolyte.corrode.across.macro-inspection|Corrosion cell|Steel electrolyte|Corrosion|Across|Macro 3D corrosion cell where steel electrolyte corrodes across anode cathode surfaces with pits and current paths
visual.composition.polymer-curing-mold.resin-gel.solidify.inside.cutaway-section|Polymer curing mold|Resin gel|Solidification|Inside|3D cast mold where resin gel solidifies inside form with cure front heat release and shrinkage stress
visual.scene.catalyst-bed.gas-mixture.react.through.cutaway-section|Catalyst bed|Gas mixture|Catalytic reaction|Through|3D catalyst bed where gas mixture reacts through porous pellets with concentration boundary layers and heat spots
visual.process.electrolysis-cell.water-ions.split.between.instrumented-lab-view|Electrolysis cell|Water ions|Splitting|Between|3D electrolysis cell where water ions split between electrodes with hydrogen bubbles oxygen plume and voltage field
visual.material.battery-separator.lithium-ions.diffuse.through.macro-inspection|Battery separator|Lithium ions|Diffusion|Through|Macro 3D battery separator where lithium ions diffuse through polymer membrane with dendrite risk zones and concentration maps
visual.scene.kiln-room.porcelain.sinter.inside.instrumented-lab-view|Kiln room|Porcelain|Sintering|Inside|3D kiln chamber where porcelain sinters inside radiant heat field with shrinkage cracks glaze flow and humidity traces
visual.process.forge-cell.molten-steel.weld.along.cinematic-volume|Forge cell|Molten steel|Welding|Along|Cinematic 3D forge cell with molten steel welding along seam line arc plasma sparks and heat affected zones
visual.composition.textile-loom.carbon-fiber.weave.across.cutaway-section|Textile loom|Carbon fiber|Weaving|Across|3D textile loom where carbon fiber weaves across a tensioned frame with over under path and anisotropic stiffness arrows
visual.material.additive-printer-bed.ceramic-powder.sinter.under.macro-inspection|Additive printer bed|Ceramic powder|Laser sintering|Under|Macro 3D printer bed with ceramic powder sintering under laser scan path and melt pool thermal gradient
visual.scene.flywheel-vault.magnet-steel.spin.inside.cutaway-section|Flywheel vault|Magnet steel|Spin|Inside|3D flywheel vault where magnet steel spins inside vacuum chamber with bearing fields hoop stress and stored energy readouts
visual.process.hydrogen-electrolyzer.water-gas-bubbles.separate.through.instrumented-lab-view|Hydrogen electrolyzer|Water gas bubbles|Separation|Through|3D electrolyzer where water gas bubbles separate through membrane stack with ion flow and pressure equalization
visual.composition.molten-salt-battery.graphite-foam.breathe.through.cutaway-section|Molten salt battery|Graphite foam|Porous breathing|Through|3D molten salt battery where graphite foam breathes through porous electrode with salt circulation heat bands and charge paths
visual.material.thermal-storage-tank.phase-change-salt.melt.inside.cutaway-section|Thermal storage tank|Phase change salt|Melting|Inside|3D thermal storage tank where phase change salt melts inside insulated vessel with latent heat front and coil exchanger
visual.scene.power-substation.copper-busbar.heat.under.system-diagram|Power substation|Copper busbar|Heating|Under|3D power substation where copper busbar heats under load surge with breaker states transformer oil flow and fault paths
visual.process.subway-tunnel-grid.human-agents.queue.at.dynamic-motion-trace|Subway tunnel grid|Human agents|Queueing|At|3D subway station with human agents queueing at platform edge route constraints train arrivals and density pressure maps
visual.composition.traffic-interchange.vehicle-streams.reroute.between.topographic-map|Traffic interchange|Vehicle streams|Rerouting|Between|3D traffic interchange where vehicle streams reroute between blocked links with queue spillback and signal timing overlays
visual.scene.water-treatment-plant.chlorinated-water.pump.through.cutaway-section|Water treatment plant|Chlorinated water|Pumping|Through|3D water treatment plant where chlorinated water pumps through filter beds with turbidity gradients and valve states
visual.material.shipping-port.cargo-containers.jam.around.system-diagram|Shipping port|Cargo containers|Queue jam|Around|3D shipping port where cargo containers jam around crane queue with berth schedules and route bottlenecks
visual.process.hospital-triage.human-agents.balance.between.dynamic-motion-trace|Hospital triage|Human agents|Load balancing|Between|3D hospital triage where human agents balance between service desks with wait-time contours and resource constraints
visual.scene.market-floor.paper-orders.queue.through.system-diagram|Market floor|Paper orders|Queueing|Through|3D market floor abstraction where paper orders queue through a matching engine with liquidity pools and price wavefronts
visual.composition.stadium-exit.crowd-flow.diffuse.through.topographic-map|Stadium exit|Crowd flow|Diffusion|Through|3D stadium exit where crowd flow diffuses through gate network with density waves obstacles and safety margins
visual.scene.vertical-farm.leaf-tissue.photosynthesize.under.instrumented-lab-view|Vertical farm|Leaf tissue|Photosynthesis|Under|3D vertical farm rack with leaf tissue photosynthesizing under LED spectrum nutrient flow mist and growth rate readouts
visual.process.irrigated-field.wet-soil.diffuse.across.topographic-map|Irrigated field|Wet soil|Diffusion|Across|3D irrigated field where wet soil diffusion crosses root zones with emitter patterns salinity fronts and plant uptake
visual.material.fermentation-vat.yeast-foam.react.inside.cutaway-section|Fermentation vat|Yeast foam|Fermentation|Inside|3D fermentation vat where yeast foam reacts inside sugar broth with CO2 bubbles heat release and concentration gradients
visual.composition.grain-silo.corn-kernels.flow.through.cutaway-section|Grain silo|Corn kernels|Granular flow|Through|3D grain silo with corn kernels flowing through discharge hopper arching zones friction cones and avalanche sheets
visual.scene.forest-canopy.water-vapor.recycle.over.atmospheric-section|Forest canopy|Water vapor|Evapotranspiration|Over|3D forest canopy where water vapor recycles over leaf layers with stomata flux and cloud feedback streamlines
visual.process.coral-reef.calcium-carbonate.grow.around.underwater-view|Coral reef|Calcium carbonate|Growth|Around|3D coral reef where calcium carbonate grows around wave exposed colony with pH stress bands and fish flow paths
visual.material.wetland-marsh.methane-bubbles.release.through.cutaway-section|Wetland marsh|Methane bubbles|Release|Through|3D wetland marsh where methane bubbles release through mud root mat with redox layers and microbial production pockets
visual.composition.beehive.wax-comb.swarm.around.macro-inspection|Beehive|Wax comb|Swarming|Around|3D beehive wax comb with bees swarming around a thermal cluster airflow paths and brood heat map
visual.scene.ant-colony.soil-grains.transport.along.cutaway-section|Ant colony|Soil grains|Transport|Along|3D ant colony cutaway where soil grains transport along tunnel network with pheromone trails traffic jams and chamber loads
visual.process.mycorrhizal-network.phosphate-ions.exchange.between.rhizosphere-depth-stack|Mycorrhizal network|Phosphate ions|Exchange|Between|3D mycorrhizal network exchanging phosphate ions between root and fungus with hyphae branches and nutrient accounting
visual.material.seaweed-farm.algae-strands.grow.along.underwater-view|Seaweed farm|Algae strands|Growth|Along|3D seaweed farm where algae strands grow along wave current with drag bending nutrient uptake and harvest lanes
visual.scene.fire-ecology.charred-wood.regrow.from.topographic-map|Fire ecology plot|Charred wood|Regrowth|From|3D postfire ecology scene where charred wood regrows from seed bank with nutrient pulses erosion risk and canopy recovery
visual.scene.double-pendulum.steel-arms.chaotic-swing.between.instrumented-lab-view|Double pendulum lab|Steel arms|Chaotic swing|Between|3D double pendulum with steel arms swinging between phase space lobes, tracing strange attractor ribbons, angular velocity colors, and energy exchange readouts
visual.process.lorenz-attractor.ink-particles.advect.around.dynamic-motion-trace|Lorenz attractor tank|Ink particles|Advection|Around|Volumetric 3D Lorenz attractor where ink particles advect around a butterfly manifold with divergence vectors and sensitivity-to-initial-condition trails
visual.composition.reaction-network.chemical-species.oscillate.inside.system-diagram|Reaction network|Chemical species|Oscillation|Inside|3D phase portrait of chemical species oscillating inside coupled reaction network with nullclines, limit cycles, and concentration surfaces
visual.material.fractal-coastline.terrain-height.recurse.along.topographic-map|Fractal coastline|Terrain height|Recursive erosion|Along|3D fractal coastline terrain recursing along self similar boundaries with erosion channels, dimension rulers, and multi-scale wave attack
visual.scene.boolean-circuit.silicon-gates.switch.through.system-diagram|Boolean circuit|Silicon gates|Switching|Through|3D logic circuit with silicon gates switching through a logic net, current pulses, truth-table probes, and timing hazards
visual.process.compiler-pipeline.syntax-tokens.lower.into.system-diagram|Compiler pipeline|Syntax tokens|Lowering|Into|3D compiler pipeline where syntax tokens lower into execution graph nodes with dependency edges, type constraints, and transform receipts
visual.composition.database-index.key-ranges.rebalance.between.cutaway-section|Database index|Key ranges|Rebalancing|Between|3D B-tree index cutaway where key ranges rebalance between pages with split events, cache heat, and query path traces
visual.material.neural-network.activations.diffuse.across.dynamic-motion-trace|Neural network|Activations|Diffusion|Across|3D embedding manifold where activations diffuse across semantic regions with attention arcs, cluster basins, and confidence contours
visual.scene.nuclear-reactor.water-moderator.thermalize.around.cutaway-section|Nuclear reactor|Water moderator|Neutron thermalization|Around|3D reactor cutaway where water moderator thermalizes neutrons around fuel assemblies with flux contours, heat channels, and control rod shadows
visual.process.fission-chain.uranium-fuel.split.inside.instrumented-lab-view|Fission chain|Uranium fuel|Splitting|Inside|3D neutron field where uranium fuel splits inside a fission chain with branching events, delayed neutron markers, and heat release surfaces
visual.composition.fusion-pellet.deuterium-tritium.compress.under.cinematic-volume|Fusion pellet|Deuterium tritium|Compression|Under|Cinematic 3D inertial fusion pellet compressed under laser implosion with shock shells, hot spot ignition, and symmetry-error glyphs
visual.material.radiation-shield.boron-carbide.absorb.through.cutaway-section|Radiation shield|Boron carbide|Absorption|Through|3D boron carbide radiation shield absorbing neutron flux through layered material with attenuation bands and capture reaction markers
visual.scene.operating-room.blood-flow.pump.through.instrumented-lab-view|Operating room|Blood flow|Pumping|Through|3D operating-room bypass circuit where blood flow pumps through tubing with pressure gauges, clot risk zones, and oxygenation color fields
visual.process.drug-delivery.lipid-nanoparticles.diffuse.across.macro-inspection|Drug delivery tissue|Lipid nanoparticles|Diffusion|Across|Macro 3D tissue scene where lipid nanoparticles diffuse across a cell barrier with uptake probabilities, receptor binding, and clearance paths
visual.composition.immune-response.t-cells.swarm.around.microscopic-flux-plot|Immune response|T cells|Swarming|Around|3D immune response where T cells swarm around tumor boundary with chemokine gradients, contact events, and exhaustion markers
visual.material.bone-remodeling.hydroxyapatite.resorb.between.macro-inspection|Bone remodeling|Hydroxyapatite|Resorption|Between|Macro 3D bone remodeling where hydroxyapatite resorbs between osteoclast fronts with porous trabeculae and mineral deposition bands
visual.scene.skyscraper-frame.steel-beams.vibrate.under.cutaway-section|Skyscraper frame|Steel beams|Vibration|Under|3D skyscraper frame vibrating under wind load with mode shapes, tuned mass damper motion, and stress hot spots
visual.process.bridge-cable.steel-strands.fatigue.along.instrumented-section|Bridge cable|Steel strands|Fatigue|Along|3D bridge cable where steel strands fatigue along load cycles with crack nucleation, rainflow counters, and tension distribution
visual.composition.earthquake-isolator.rubber-bearings.shear.between.cutaway-section|Earthquake isolator|Rubber bearings|Shear|Between|3D base isolation system where rubber bearings shear between foundation and building with displacement loops and damping energy readouts
visual.material.smart-glass.electrochromic-film.switch.across.macro-inspection|Smart glass|Electrochromic film|Switching|Across|Macro 3D smart glass pane where electrochromic film switches across window layers with ion migration and tint gradients
visual.scene.electric-aircraft.battery-pack.heat.under.system-diagram|Electric aircraft|Battery pack|Heating|Under|3D electric aircraft battery pack heating under climb load with thermal runaway barriers, cooling channels, and power bus flows
visual.process.turbofan-engine.airflow.compress.through.cutaway-section|Turbofan engine|Airflow|Compression|Through|3D turbofan cutaway where airflow compresses through blade stages with pressure ratios, shock cells, and turbine heat bands
visual.composition.ev-drivetrain.electrons.flow.between.system-diagram|EV drivetrain|Electrons|Flow|Between|3D EV drivetrain where electrons flow between inverter and motor with switching pulses, magnetic torque fields, and regen paths
visual.material.tire-contact.rubber-tread.deform.over.macro-inspection|Tire contact patch|Rubber tread|Deformation|Over|Macro 3D tire contact patch where rubber tread deforms over wet asphalt with water evacuation, friction cones, and slip ratio trails
visual.scene.orchestra-hall.sound-waves.interfere.between.cinematic-volume|Orchestra hall|Sound waves|Interference|Between|3D orchestra hall where sound waves interfere between instrument sections with phase fronts, room modes, and absorption surfaces
visual.process.violin-string.steel-core.oscillate.under.macro-inspection|Violin string|Steel core|Oscillation|Under|Macro 3D violin string oscillating under bow friction with stick-slip cycles, harmonic nodes, and resonant body coupling
visual.composition.synthesizer-filter.voltage-signal.resonate.inside.system-diagram|Synthesizer filter|Voltage signal|Resonance|Inside|3D synthesizer filter where voltage signal resonates inside ladder circuit with cutoff surface, feedback loop, and waveform morphing
visual.material.speaker-cone.paper-fiber.vibrate.against.macro-inspection|Speaker cone|Paper fiber|Vibration|Against|Macro 3D speaker cone where paper fiber vibrates against air pressure with displacement mesh, voice coil field, and acoustic radiation
visual.scene.global-climate.ocean-air.exchange.between.atmospheric-section|Global climate|Ocean air|Heat exchange|Between|3D climate section where ocean and air exchange heat between reservoirs with circulation cells, albedo patches, and carbon flux arrows
visual.process.carbon-cycle.co2-molecules.transport.through.system-diagram|Carbon cycle|CO2 molecules|Transport|Through|3D carbon cycle where CO2 molecules transport through biosphere ocean and atmosphere with source sinks, residence times, and feedback loops
visual.composition.ice-albedo.snow-surface.reflect.over.topographic-map|Ice albedo field|Snow surface|Reflection|Over|3D ice albedo field where snow surface reflects over melting ground with absorbed solar energy, melt ponds, and feedback gain
visual.material.permafrost-soil.methane-hydrate.release.from.cutaway-section|Permafrost soil|Methane hydrate|Release|From|3D permafrost cutaway where methane hydrate releases from thaw front with microbial zones, gas pockets, and ground subsidence
visual.scene.food-web.plankton-biomass.transfer.through.system-diagram|Food web|Plankton biomass|Energy transfer|Through|3D food web where plankton biomass transfers through predator chain with trophic efficiencies, population flows, and collapse thresholds
visual.process.crop-disease.spores.diffuse.across.topographic-map|Crop disease field|Spores|Diffusion|Across|3D crop field where spores diffuse across canopy rows with humidity pockets, infection fronts, and intervention zones
visual.composition.irrigation-network.water-pressure.balance.between.system-diagram|Irrigation network|Water pressure|Balancing|Between|3D irrigation network where water pressure balances between valve zones with emitter flow, soil moisture, and pump load
visual.material.grain-storage.wheat-kernels.heat.inside.cutaway-section|Grain storage|Wheat kernels|Self heating|Inside|3D silo core where wheat kernels heat inside storage with moisture gradients, fungal risk, and ventilation paths
visual.scene.bank-run.depositors.queue.at.dynamic-motion-trace|Bank run|Depositors|Queueing|At|3D financial crowd model where depositors queue at liquidity window with confidence contagion, reserve levels, and withdrawal waves
visual.process.supply-chain.parts-flow.reroute.between.system-diagram|Supply chain|Parts flow|Rerouting|Between|3D supply chain graph where parts flow reroutes between factory nodes with lead-time queues, inventory buffers, and bottleneck shocks
visual.composition.social-network.opinion-states.diffuse.across.dynamic-motion-trace|Social network|Opinion states|Diffusion|Across|3D social network where opinion states diffuse across friend edges with influence weights, echo clusters, and polarization surfaces
visual.material.auction-market.bid-orders.compete.inside.system-diagram|Auction market|Bid orders|Competition|Inside|3D auction market where bid orders compete inside price ladder with liquidity depth, matching events, and spread dynamics
visual.scene.legal-system.case-files.queue.through.system-diagram|Legal system|Case files|Queueing|Through|3D court docket where case files queue through hearings with resource constraints, precedent edges, and delay accumulation
visual.process.classroom-learning.memory-traces.strengthen.across.dynamic-motion-trace|Classroom learning|Memory traces|Strengthening|Across|3D learning model where memory traces strengthen across practice sessions with forgetting curves, retrieval boosts, and concept graph links
visual.composition.language-change.phonemes.diffuse.through.system-diagram|Language change|Phonemes|Diffusion|Through|3D speaker network where phonemes diffuse through communities with adoption fronts, contact boundaries, and prestige weights
visual.material.book-archive.paper-fibers.decay.under.macro-inspection|Book archive|Paper fibers|Decay|Under|Macro 3D book archive where paper fibers decay under humidity cycle with acid migration, brittleness cracks, and preservation airflow
visual.scene.mars-habitat.co2-air.recycle.through.cutaway-section|Mars habitat|CO2 air|Recycling|Through|3D Mars habitat where CO2 air recycles through life support loop with scrubbers, plant beds, pressure shells, and failure sensors
visual.process.orbital-construction.aluminum-trusses.assemble.around.wide-establishing-view|Orbital construction|Aluminum trusses|Assembly|Around|3D orbital construction where aluminum trusses assemble around station core with robot arms, docking constraints, and inertia markers
visual.composition.lunar-mass-driver.regolith-pellets.accelerate.along.instrumented-space-view|Lunar mass driver|Regolith pellets|Acceleration|Along|3D lunar mass driver accelerating regolith pellets along magnetic track with coil timing, launch arcs, and dust plume effects
visual.material.space-elevator.ribbon-carbon-nanotube.tension.between.wide-establishing-view|Space elevator|Carbon nanotube ribbon|Tension|Between|3D space elevator ribbon under tension between Earth and counterweight with oscillation modes, climber loads, and micrometeor damage
visual.scene.superconducting-qubit.niobium.josephson-oscillation.inside.phase-readout-view|Superconducting qubit chip|Niobium film|Josephson oscillation|Inside|Cryogenic 3D qubit chip with niobium traces, Josephson junction islands, microwave control lines, phase readout arcs, and thermal shielding layers
visual.scene.quantum-dot-array.silicon-tunnel-barriers.charge-hopping.between.gate-stack-view|Quantum dot array|Silicon tunnel barriers|Charge hopping|Between|Semiconductor dot lattice with gated wells, charge occupation colors, tunnel barrier heights, and measurement probes suspended above the stack
visual.scene.ion-trap-chain.gold-electrodes.coulomb-oscillation.along.vacuum-rail-view|Ion trap chain|Gold electrodes|Coulomb oscillation|Along|Linear ion trap with glowing ions oscillating above segmented gold rails, laser beams intersecting each ion, and phonon modes drawn as standing ribbons
visual.scene.electron-microscope.column-vacuum.beam-focusing.through.lens-stack-view|Electron microscope column|Column vacuum|Beam focusing|Through|Cutaway electron microscope with magnetic lenses focusing a charged beam through apertures, sample grid, detector cones, and field contour shells
visual.scene.graphene-sheet.graphene-strain.wrinkle-propagation.across.nano-membrane-view|Graphene strain sheet|Graphene|Wrinkle propagation|Across|Single layer graphene membrane wrinkling across supports with strain tensors, defect points, ripples, and electron mobility color bands
visual.scene.crystal-dislocation.aluminum-lattice.slip-motion.through.unit-cell-view|Crystal dislocation lattice|Aluminum lattice|Slip motion|Through|Atomic lattice with edge dislocation line sliding through unit cells, shear arrows, vacancy clusters, and stress halos around each defect
visual.scene.tribology-bearing.steel-ceramic.frictional-heating.between.contact-patch-view|Tribology bearing contact|Steel ceramic|Frictional heating|Between|Bearing contact patch with asperity peaks, lubricant film thickness, heat plumes, pressure ellipses, and wear particle trails
visual.scene.photonic-crystal.dielectric-pillars.bandgap-guidance.through.waveguide-view|Photonic crystal slab|Dielectric pillars|Bandgap guidance|Through|Photonic crystal lattice guiding light through a defect channel with forbidden band shadows, phase fronts, and resonant cavity hotspots
visual.scene.metamaterial-cloak.copper-split-rings.field-bending.around.hidden-core-view|Metamaterial cloak ring|Copper split rings|Field bending|Around|Concentric split ring metamaterial shell bending waves around a hidden core, showing field vectors, phase delay, and scattering cancellation
visual.scene.laser-cavity.mirrored-gas.mode-locking.between.optical-bench-view|Laser cavity|Mirrored gas|Mode locking|Between|Optical cavity between curved mirrors with standing pulse train, gain medium glow, aperture losses, and stabilized mode envelope
visual.scene.lava-tube.basalt-melt.viscous-advection.through.cave-cutaway-view|Lava tube flow|Basalt melt|Viscous advection|Through|Subsurface lava tube cutaway with glowing basalt melt, cooling crust, flow fronts, gas pockets, and thermal gradients through the cave wall
visual.scene.glacier-crevasse.blue-ice.fracture-opening.across.ice-field-view|Glacier crevasse field|Blue ice|Fracture opening|Across|3D glacier surface with crevasses opening across blue ice, tensile stress bands, meltwater veins, and snow bridges casting sharp shadows
visual.scene.river-delta.silt-water.sediment-deposition.into.distributary-view|River delta plume|Silt water|Sediment deposition|Into|River delta where sediment-laden water fans into the sea, distributary channels split, bars accrete, and salinity fronts curl offshore
visual.scene.desert-dune.quartz-sand.wind-migration.over.ripple-field-view|Desert dune migration|Quartz sand|Wind migration|Over|Crescent dune field with sand grains saltating over ripples, slip face avalanches, wind vectors, and shadowed lee vortices
visual.scene.wildfire-plume.hot-smoke.turbulent-entrainment.above.forest-front-view|Wildfire plume|Hot smoke|Turbulent entrainment|Above|Wildfire front with smoke column entraining air above trees, ember particles, radiant heat shells, and vortex rings rising through the plume
visual.scene.coral-reef.calcium-carbonate.bleaching-diffusion.across.reef-shelf-view|Coral reef bleaching|Calcium carbonate reef|Bleaching diffusion|Across|Coral reef shelf with bleaching patches spreading across colonies, thermal stress contours, symbiotic algae density, and water clarity layers
visual.scene.estuary-salt-wedge.brackish-water.density-intrusion.under.river-mouth-view|Estuary salt wedge|Brackish water|Density intrusion|Under|Estuary cutaway with dense salt wedge intruding under river flow, mixing shear, tidal pulses, and suspended sediment ribbons
visual.scene.soil-hydrology.loam-water.infiltration.through.root-column-view|Soil hydrology column|Loam water|Infiltration|Through|Soil column with rainfall infiltrating through loam pores, root uptake nodes, capillary fringes, and nutrient concentration gradients
visual.scene.wind-turbine-wake.turbulent-air.wake-shedding.behind.rotor-array-view|Wind turbine wake|Turbulent air|Wake shedding|Behind|Offshore turbine array with helical wake shedding behind rotors, velocity deficits, blade tip vortices, and farm scale interference bands
visual.scene.hydro-turbine.water-steel.cavitation.around.runner-cutaway-view|Hydro turbine cavitation|Water steel|Cavitation|Around|Hydro turbine runner cutaway with cavitation bubbles forming around blades, pressure minima, torque arrows, and vapor collapse hotspots
visual.scene.geothermal-reservoir.granite-brine.heat-extraction.through.fracture-network-view|Geothermal reservoir|Granite brine|Heat extraction|Through|Enhanced geothermal reservoir with brine flowing through fractured granite, injection wells, production wells, and heat depletion fronts
visual.scene.carbon-capture-column.amine-solvent.gas-absorption.through.packed-bed-view|Carbon capture column|Amine solvent|Gas absorption|Through|Tall packed absorption column with flue gas rising through amine solvent, CO2 loading bands, tray hydraulics, and regeneration flow arrows
visual.scene.desalination-membrane.polymer-film.reverse-osmosis.across.spiral-module-view|Desalination membrane|Polymer film|Reverse osmosis|Across|Spiral wound desalination module with seawater crossing membrane leaves, pressure gradients, brine reject streams, and permeate collection tubes
visual.scene.pipeline-slug-flow.oil-gas.two-phase-surge.through.elbow-view|Pipeline slug flow|Oil gas mix|Two phase surge|Through|Pipeline elbow with liquid slugs and gas pockets surging through, pressure sensors, wall shear colors, and separator inlet waves
visual.scene.distillation-column.hydrocarbon-vapor.phase-separation.inside.tray-stack-view|Distillation column|Hydrocarbon vapor|Phase separation|Inside|Tray distillation column with rising vapor, descending liquid, temperature ladder, reflux arcs, and component purity bands across each tray
visual.scene.catalytic-cracker.zeolite-catalyst.cracking-reaction.through.riser-view|Catalytic cracker|Zeolite catalyst|Cracking reaction|Through|Fluid catalytic cracker riser with catalyst particles carrying hydrocarbon vapor, reaction heat, cyclone separation, and coke deposition colors
visual.scene.drone-swarm.carbon-composite.consensus-control.above.city-grid-view|Drone swarm|Carbon composite|Consensus control|Above|Drone swarm above a city grid with formation graph edges, local sensing cones, collision constraints, and battery state halos
visual.scene.soft-robot-gripper.silicone-elastomer.pressure-actuation.around.delicate-object-view|Soft robot gripper|Silicone elastomer|Pressure actuation|Around|Soft pneumatic gripper wrapping around a delicate object, showing chamber pressure, strain fields, contact patches, and valve timing traces
visual.scene.autonomous-merge.vehicle-agents.gap-selection.between.lane-flow-view|Autonomous vehicle merge|Vehicle agents|Gap selection|Between|Highway merge scene with autonomous vehicles selecting gaps between lane flows, predicted trajectories, sensor frustums, and right of way fields
visual.scene.exoskeleton-gait.carbon-braces.torque-assist.along.human-stride-view|Exoskeleton gait|Carbon braces|Torque assist|Along|Powered exoskeleton assisting a human stride with joint torque vectors, gait phase arcs, foot pressure maps, and actuator heat markers
visual.scene.surgical-robot.stainless-tools.motion-scaling.inside.operating-field-view|Surgical robot|Stainless tools|Motion scaling|Inside|Robotic surgical field with articulated tools scaled through a trocar, tissue boundaries, force feedback colors, and no fly constraint volumes
visual.scene.satellite-attitude.aluminum-bus.reaction-wheel-control.around.orbit-frame-view|Satellite attitude control|Aluminum bus|Reaction wheel control|Around|Satellite bus rotating in orbit frame with reaction wheel momentum vectors, star tracker cones, solar torque arrows, and attitude error quaternions
visual.scene.adaptive-telescope.glass-mirror.wavefront-correction.across.segmented-aperture-view|Adaptive telescope mirror|Glass mirror|Wavefront correction|Across|Segmented telescope mirror correcting atmospheric wavefronts with actuator pistons, phase residual heatmap, guide star beams, and diffraction rings
visual.scene.rover-wheel.regolith-soil.traction-slip.over.crater-slope-view|Rover wheel regolith|Regolith soil|Traction slip|Over|Rover wheel climbing crater regolith with sinkage, slip ratio, granular shear wedges, and torque feedback rendered around the tread
visual.scene.neuron-synapse.neural-tissue.spike-transmission.across.synaptic-cleft-view|Neuron synapse|Neural tissue|Spike transmission|Across|Microscopic synapse with vesicle release across a cleft, receptor gates, calcium pulses, and spike timing curves along branching dendrites
visual.scene.kidney-nephron.blood-filtrate.selective-filtration.through.tubule-loop-view|Kidney nephron|Blood filtrate|Selective filtration|Through|Nephron loop cutaway with filtrate moving through tubules, osmotic gradient, ion exchange pumps, capillary flow, and reabsorption markers
visual.scene.lung-alveoli.air-blood.gas-exchange.across.capillary-surface-view|Lung alveoli|Air blood interface|Gas exchange|Across|Alveolar cluster with oxygen and CO2 crossing thin capillary surfaces, surfactant film, breathing expansion, and perfusion color fields
visual.scene.retina-photoreceptor.opsin-stack.photon-transduction.through.outer-segment-view|Retina photoreceptor|Opsin stack|Photon transduction|Through|Photoreceptor outer segment with photons triggering opsin cascades, ion channels closing, membrane potential traces, and retinal layer depth
visual.scene.protein-folding.amino-chain.energy-minimization.into.native-state-view|Protein folding|Amino chain|Energy minimization|Into|Amino acid chain folding into a native basin with hydrogen bonds, hydrophobic collapse, free energy contours, and misfolded branch ghosts
visual.scene.enzyme-kinetics.protein-substrate.binding-turnover.inside.active-site-view|Enzyme kinetics|Protein substrate|Binding turnover|Inside|Enzyme active site with substrate binding, transition state stabilization, product release, and rate constants displayed as reaction flux ribbons
visual.scene.cell-membrane.lipid-bilayer.ion-transport.across.channel-array-view|Cell membrane transport|Lipid bilayer|Ion transport|Across|Lipid bilayer with ion channels transporting charge across the membrane, electrochemical gradient, gating states, and local fluidity patches
visual.scene.plant-stomata.leaf-tissue.transpiration-control.through.guard-cells-view|Plant stomata|Leaf tissue|Transpiration control|Through|Leaf surface with stomata opening through guard cells, vapor flux, CO2 uptake, turgor pressure, and sunlight driven control loops
visual.scene.auction-market.bid-agents.price-discovery.between.order-book-view|Auction market|Bid agents|Price discovery|Between|Market order book with bid agents discovering price, liquidity cliffs, crossing orders, latency paths, and volatility surface above the ledger
visual.scene.supply-chain-shock.container-flow.delay-propagation.through.logistics-network-view|Supply chain shock|Container flow|Delay propagation|Through|Global logistics network with container delays propagating through ports, warehouses, rail links, inventory buffers, and demand shock pulses
visual.scene.epidemic-contact.human-contacts.transmission-spread.across.network-graph-view|Epidemic contact graph|Human contacts|Transmission spread|Across|Contact network with infection spreading across human nodes, exposure weights, isolation cuts, vaccination shields, and time layered incidence curves
visual.scene.evacuation-corridor.crowd-agents.bottleneck-flow.through.exit-funnel-view|Evacuation corridor|Crowd agents|Bottleneck flow|Through|Emergency corridor with crowd agents funneling through exits, density pressure, route choices, blocked edges, and signage control fields
visual.scene.school-hallway.student-agents.counterflow.between.classroom-bells-view|School hallway crowd|Student agents|Counterflow|Between|School hallway during bell change with student agents moving in counterflow, doorway eddies, locker obstacles, and route preference colors
visual.scene.port-container-yard.steel-containers.crane-scheduling.across.berth-grid-view|Port container yard|Steel containers|Crane scheduling|Across|Container port with cranes scheduling moves across berth grid, stack heights, truck queues, vessel cutoff deadlines, and routing lanes
visual.scene.power-grid-islanding.copper-lines.load-balancing.across.substation-network-view|Power grid islanding|Copper lines|Load balancing|Across|Electrical grid splitting into islands with load balancing across substations, frequency drift, breaker states, and renewable intermittency traces
visual.scene.water-network.pressurized-water.demand-pulses.through.pipe-graph-view|Water network pressure|Pressurized water|Demand pulses|Through|Municipal water network with pressure demand pulses moving through pipe graph, valve states, pump curves, and leak likelihood halos
visual.scene.magma-chamber.silicate-melt.pressure-inflation.under.volcanic-edifice-view|Magma chamber|Silicate melt|Pressure inflation|Under|Volcano cutaway with magma chamber inflating under edifice, dike propagation, gas exsolution, ground deformation, and seismic swarm markers
visual.scene.landslide-slope.wet-regolith.shear-failure.along.slip-plane-view|Landslide shear plane|Wet regolith|Shear failure|Along|Mountain slope with wet regolith failing along a slip plane, pore pressure bands, root reinforcement, and runout path particles
visual.scene.avalanche-slab.snowpack-crystals.crack-propagation.across.weak-layer-view|Avalanche slab|Snowpack crystals|Crack propagation|Across|Snowpack slab crack propagating across weak layer with crystal bonds, load zones, fracture front, and avalanche release contour
visual.scene.ocean-internal-wave.stratified-water.density-oscillation.under.thermocline-view|Ocean internal wave|Stratified water|Density oscillation|Under|Ocean cutaway with internal waves oscillating under thermocline, pycnocline displacement, shear billows, and mixing energy contours
visual.scene.sea-ice-ridge.frozen-brine.compression-ridging.between.floe-field-view|Sea ice ridging|Frozen brine|Compression ridging|Between|Sea ice floes compressing into ridges with brine channels, keel geometry, pressure arrows, and lead openings across the field
visual.scene.jet-stream.air-mass.vorticity-advection.along.planetary-wave-view|Atmospheric jet stream|Air mass|Vorticity advection|Along|Jet stream ribbon advecting vorticity along planetary waves, tropopause height, temperature gradients, and storm track branching
visual.scene.black-hole-jet.plasma-disk.relativistic-collimation.above.accretion-shadow-view|Black hole accretion jet|Plasma disk|Relativistic collimation|Above|Black hole disk launching relativistic jets above the accretion shadow with magnetic field lines, Doppler beaming, and hot spot orbits
visual.scene.gravitational-wave-detector.laser-vacuum.interferometer-strain.between.arm-cavity-view|Gravitational wave detector|Laser vacuum|Interferometer strain|Between|L shaped interferometer with laser beams between vacuum arms, strain ripples, mirror suspension stages, and phase shift readout
visual.scene.spacecraft-heat-shield.ablative-tile.thermal-protection.under.reentry-load-view|Spacecraft heat shield|Ablative tile|Thermal protection|Under|Capsule heat shield under reentry load with ablative tile recession, shock layer glow, heat flux vectors, and structural temperature maps
visual.scene.reentry-plasma.ionized-air.shock-ionization.around.capsule-sheath-view|Reentry plasma sheath|Ionized air|Shock ionization|Around|Reentry capsule wrapped in ionized plasma sheath with bow shock, blackout region, ablation particles, and pressure contours around the body
visual.scene.battery-runaway.lithium-cell.exothermic-propagation.through.module-stack-view|Battery thermal runaway|Lithium cell|Exothermic propagation|Through|Battery module with thermal runaway propagating through cells, vent gas jets, separator failure, heat shields, and fuse link states
visual.scene.semiconductor-lithography.photoresist-wafer.pattern-exposure.across.stepper-field-view|Semiconductor lithography|Photoresist wafer|Pattern exposure|Across|Lithography stepper exposing photoresist across a wafer field with mask shadows, focus map, overlay error, and diffraction limited edges
visual.scene.microfluidic-chip.aqueous-droplets.droplet-splitting.through.channel-network-view|Microfluidic lab chip|Aqueous droplets|Droplet splitting|Through|Microfluidic chip where droplets split through channel junctions, surface tension gates, reagent gradients, and optical sensor windows
visual.scene.textile-weave.fiber-yarns.tension-coupling.between.warp-weft-view|Textile weave stress|Fiber yarns|Tension coupling|Between|Warp and weft yarns coupling tension across a textile weave, contact friction, fiber strain, and drape curvature over a form
visual.scene.sediment-core.clay-layers.compaction-settling.through.basin-column-view|Sediment core compaction|Clay layers|Compaction settling|Through|Sediment basin column with clay layers compacting through burial, pore fluid escape, grain contacts, and chronology markers
visual.scene.permafrost-thaw.ice-rich-soil.phase-collapse.under.tundra-surface-view|Permafrost thaw|Ice rich soil|Phase collapse|Under|Tundra cutaway with permafrost thaw collapsing ice rich soil, methane pockets, thermokarst pools, and active layer deepening
visual.scene.rainforest-canopy.leaf-air.transpiration-coupling.above.forest-layer-view|Rainforest canopy|Leaf air|Transpiration coupling|Above|Rainforest canopy exchanging moisture above layered trees with stomatal flux, turbulence, rainfall interception, and carbon uptake fields
visual.scene.lake-turnover.freshwater-strata.convective-mixing.through.seasonal-column-view|Lake turnover|Freshwater strata|Convective mixing|Through|Seasonal lake column turning over as freshwater strata mix, temperature inversion breaks, oxygen redistributes, and nutrient plumes rise
visual.scene.particle-collider.muon-tracks.collision-plume.through.detector-slice-view|Particle collider event|Muon tracks|Collision plume|Through|3D detector slice with muon tracks spiraling through calorimeter layers, collision vertex glow, momentum arcs, and event selection gates
visual.scene.neutrino-detector.clear-water.photon-cone.across.underground-tank-view|Neutrino detector|Clear water|Photon cone|Across|Underground water Cherenkov tank with faint photon cones crossing phototube walls, timestamp rings, and background rejection volumes
visual.scene.cosmic-ray-shower.ionized-air.particle-cascade.through.upper-atmosphere-view|Cosmic ray shower|Ionized air|Particle cascade|Through|Atmosphere column where a cosmic ray shower cascades through ionized air, branching secondaries, fluorescence streaks, and ground array triggers
visual.scene.planetary-rings.ice-boulders.shepherd-resonance.around.gas-giant-view|Planetary rings|Ice boulders|Shepherd resonance|Around|Gas giant ring plane with ice boulders shepherded by moons, resonance gaps, collisional wakes, and orbital density waves
visual.scene.exoplanet-atmosphere.hydrogen-haze.transit-absorption.through.starlight-limb-view|Exoplanet atmosphere|Hydrogen haze|Transit absorption|Through|Exoplanet limb during transit with starlight filtering through hydrogen haze, spectral bands, wind jets, and terminator temperature gradients
visual.scene.asteroid-rubble-pile.regolith-blocks.spin-failure.along.equator-ridge-view|Asteroid rubble pile|Regolith blocks|Spin failure|Along|Rubble pile asteroid spinning toward equator failure with boulder contact forces, dust lofting, and weak gravity escape arcs
visual.scene.comet-tail.volatile-ice.sublimation-plume.away.sunward-shadow-view|Comet tail|Volatile ice|Sublimation plume|Away|Comet nucleus sublimating volatile ice into dust and ion tails, solar wind vectors, blue plasma streamers, and shadowed crust jets
visual.scene.solar-flare.magnetized-plasma.reconnection-above.active-region-view|Solar flare|Magnetized plasma|Reconnection|Above|Solar active region with magnetized plasma reconnecting above sunspots, flare loops, particle beams, and radiation pulse shells
visual.scene.aurora-curtain.oxygen-nitrogen.particle-precipitation.along.magnetic-field-view|Aurora curtain|Oxygen nitrogen|Particle precipitation|Along|Polar aurora curtains where charged particles precipitate along magnetic field lines, emission altitude layers, and ionospheric wave fronts
visual.scene.magnetosphere.solar-wind.bow-shock-around.planetary-dipole-view|Planetary magnetosphere|Solar wind|Bow shock|Around|Planetary dipole deflecting solar wind into a bow shock, magnetotail lobes, reconnection nightside, and radiation belt particles
visual.scene.ocean-eddy.saltwater-vorticity.nutrient-upwelling.inside.mesoscale-current-view|Ocean eddy|Saltwater vorticity|Nutrient upwelling|Inside|Mesoscale ocean eddy with rotating saltwater vorticity, nutrient upwelling core, plankton response colors, and sea surface height contours
visual.scene.kelp-forest.flexible-fronds.wave-drag.through.coastal-canopy-view|Kelp forest|Flexible fronds|Wave drag|Through|Underwater kelp canopy bending through waves with drag vectors, holdfast anchors, fish paths, and nutrient uptake ribbons
visual.scene.mangrove-roots.brackish-water.flood-buffering.between.tidal-channels-view|Mangrove roots|Brackish water|Flood buffering|Between|Mangrove root maze buffering tidal floodwater between channels, sediment capture, salinity gradients, and storm surge attenuation bands
visual.scene.termite-mound.clay-pores.ventilation-through.thermal-chimney-view|Termite mound ventilation|Clay pores|Ventilation|Through|Termite mound cutaway with clay pore network ventilating through a thermal chimney, CO2 plumes, humidity shells, and colony heat nodes
visual.scene.bat-echolocation.air-pressure.echo-ranging-around.cave-obstacles-view|Bat echolocation|Air pressure waves|Echo ranging|Around|Cave scene with bat ultrasonic wavefronts echo ranging around obstacles, time of flight rings, prey scattering, and ear direction cones
visual.scene.insect-wing.chitin-membrane.vortex-lift-above.stroke-envelope-view|Insect wing lift|Chitin membrane|Vortex lift|Above|Macro insect wing generating leading edge vortices above stroke envelope, flexible vein strain, wake loops, and lift impulse glyphs
visual.scene.spider-web.silk-threads.vibration-localization.across.radial-network-view|Spider web vibration|Silk threads|Vibration localization|Across|Spider web radial network localizing prey vibrations across silk threads, tension gradients, node phase delays, and sticky capture zones
visual.scene.plankton-bloom.phytoplankton-cells.light-growth.across.mixed-layer-view|Plankton bloom|Phytoplankton cells|Light growth|Across|Ocean mixed layer with phytoplankton bloom growing across light and nutrient gradients, grazing fronts, and carbon export particles
visual.scene.whale-migration.sound-channel.acoustic-routing.through.ocean-basin-view|Whale migration|Sound channel|Acoustic routing|Through|Ocean basin with whale calls routing through deep sound channel, migration trajectories, temperature layers, and shipping noise interference
visual.scene.coral-larvae.calcium-substrate.settlement-across.reef-rubble-view|Coral larvae settlement|Calcium substrate|Settlement|Across|Reef rubble surface where coral larvae settle across calcium substrate, chemical cues, current eddies, and early polyp growth halos
visual.scene.neural-organoid.neural-cells.pattern-formation-inside.gel-droplet-view|Neural organoid|Neural cells|Pattern formation|Inside|Lab gel droplet where neural cells self-organize inside an organoid, morphogen gradients, firing islands, and growth boundary shells
visual.scene.gut-microbiome.microbial-colonies.metabolite-exchange-through.intestinal-fold-view|Gut microbiome|Microbial colonies|Metabolite exchange|Through|Intestinal fold cutaway with microbial colonies exchanging metabolites, mucus diffusion, immune sampling, and peristaltic flow bands
visual.scene.liver-lobule.blood-plasma.detox-gradient-across.hexagonal-sinusoid-view|Liver lobule|Blood plasma|Detox gradient|Across|Hexagonal liver lobule with blood plasma detox gradients across sinusoids, bile canaliculi flow, and zonated enzyme activity
visual.scene.eye-aqueous-flow.clear-fluid.pressure-drainage-through.trabecular-mesh-view|Eye aqueous flow|Clear fluid|Pressure drainage|Through|Anterior eye chamber with clear fluid draining through trabecular mesh, pressure contours, lens refraction, and optic nerve risk colors
visual.scene.cochlea-basilar-wave.inner-ear-fluid.frequency-mapping-along.spiral-cutaway-view|Cochlea basilar wave|Inner ear fluid|Frequency mapping|Along|Cochlea spiral cutaway where inner ear fluid maps frequencies along basilar membrane, hair cell activation, and traveling wave envelope
visual.scene.lymph-node-filter.lymph-fluid.antigen-sorting-through.follicle-network-view|Lymph node filter|Lymph fluid|Antigen sorting|Through|Lymph node follicle network sorting antigens through lymph fluid, immune cell paths, germinal center reactions, and exit vessel flow
visual.scene.insulin-glucose.blood-sugar.feedback-control-between.pancreas-liver-view|Insulin glucose loop|Blood sugar|Feedback control|Between|Metabolic feedback loop between pancreas and liver controlling blood sugar, insulin pulses, glycogen storage, and meal disturbance wave
visual.scene.wound-healing.fibrin-matrix.clot-remodeling-across.skin-cutaway-view|Wound healing|Fibrin matrix|Clot remodeling|Across|Skin wound cutaway where fibrin matrix remodels across injury, platelet plugs, collagen deposition, angiogenesis, and inflammation boundary
visual.scene.dna-repair.chromatin-strands.error-correction-along.replication-fork-view|DNA repair|Chromatin strands|Error correction|Along|Replication fork with chromatin strands undergoing DNA repair, mismatch markers, enzyme clamps, strand tension, and checkpoint signal halos
visual.scene.crispr-editing.guide-rna.target-binding-inside.nucleus-view|CRISPR editing|Guide RNA|Target binding|Inside|Cell nucleus where guide RNA binds DNA target, Cas complex conformations, off target risk shadows, and repair pathway branches
visual.scene.ribosome-translation.mrna-chain.codon-stepping-through.molecular-machine-view|Ribosome translation|mRNA chain|Codon stepping|Through|Molecular ribosome stepping through mRNA codons, tRNA arrivals, peptide chain growth, GTP energy ticks, and reading frame rails
visual.scene.mitochondria-atp.proton-gradient.energy-conversion-across.inner-membrane-view|Mitochondria ATP|Proton gradient|Energy conversion|Across|Mitochondrial inner membrane converting proton gradient into ATP, cristae folds, electron transport carriers, and synthase rotor motion
visual.scene.chloroplast-photosynthesis.light-quanta.carbon-fixation-inside.thylakoid-stack-view|Chloroplast photosynthesis|Light quanta|Carbon fixation|Inside|Chloroplast thylakoid stack where light quanta drive carbon fixation, electron flow, proton pools, and sugar export arrows
visual.scene.phloem-transport.sugar-sap.pressure-flow-through.plant-stem-view|Phloem transport|Sugar sap|Pressure flow|Through|Plant stem cutaway with sugar sap pressure flowing through phloem tubes, source sink gradients, companion cells, and water exchange
visual.scene.root-exudate.soil-chemicals.microbe-recruitment-around.rhizosphere-view|Root exudate|Soil chemicals|Microbe recruitment|Around|Rhizosphere scene where root exudates recruit microbes around root hairs, chemical gradients, mycorrhizal links, and nutrient exchange tokens
visual.scene.soil-carbon.humus-particles.mineral-binding-inside.aggregate-view|Soil carbon aggregate|Humus particles|Mineral binding|Inside|Soil aggregate with humus particles binding minerals inside pore spaces, microbial hotspots, water films, and carbon residence markers
visual.scene.aquifer-contamination.groundwater-plume.advection-dispersion-through.porous-strata-view|Aquifer contamination|Groundwater plume|Advection dispersion|Through|Subsurface aquifer with contaminant plume advecting through porous strata, monitoring wells, sorption zones, and cleanup pump cones
visual.scene.storm-sewer-overflow.rainwater-surge.capacity-failure-through.urban-pipe-view|Storm sewer overflow|Rainwater surge|Capacity failure|Through|Urban storm sewer network where rainwater surge exceeds capacity, manhole jets, pipe surcharge, and downstream water quality impact plumes
visual.scene.dam-sediment.reservoir-silt.trapping-behind.concrete-wall-view|Dam sediment trapping|Reservoir silt|Trapping|Behind|Dam reservoir with silt trapping behind concrete wall, density currents, turbine intake risk, and downstream sediment starvation ribbons
visual.scene.bridge-scour.river-sediment.erosion-around.pier-foundation-view|Bridge scour|River sediment|Erosion|Around|Bridge pier foundation with river sediment eroding around piles, horseshoe vortices, scour hole growth, and flood hydrograph overlays
visual.scene.railway-dispatch.train-agents.conflict-resolution-across.track-graph-view|Railway dispatch|Train agents|Conflict resolution|Across|Rail network where train agents resolve conflicts across track graph, signal blocks, platform slots, and cascading delay ribbons
visual.scene.airport-ground-ops.aircraft-agents.taxi-scheduling-between.gate-runway-view|Airport ground ops|Aircraft agents|Taxi scheduling|Between|Airport surface with aircraft agents taxi scheduling between gates and runway, conflict hot spots, wake separation, and turnaround timers
visual.scene.shipping-lane.container-vessels.congestion-routing-through.port-approach-view|Shipping lane congestion|Container vessels|Congestion routing|Through|Port approach with container vessels routing through congested lanes, pilot windows, berth queues, and tidal current vectors
visual.scene.submarine-cable.fiber-glass.signal-attenuation-along.seafloor-route-view|Submarine cable|Fiber glass|Signal attenuation|Along|Seafloor route with fiber cable signal attenuation along repeaters, fault risk zones, bathymetry shadows, and repair vessel path
visual.scene.edge-data-center.server-racks.heat-recirculation-between.cooling-aisles-view|Edge data center|Server racks|Heat recirculation|Between|Compact data center with server racks recirculating heat between cooling aisles, airflow tiles, power draw, and thermal throttling zones
visual.scene.chip-throttling.silicon-die.thermal-control-across.core-map-view|Chip thermal throttling|Silicon die|Thermal control|Across|Processor die with thermal control across core map, hotspot migration, frequency governors, and package heat spreader layers
visual.scene.wafer-polishing.silica-slurry.planarization-across.rotating-pad-view|Wafer polishing|Silica slurry|Planarization|Across|Semiconductor wafer under CMP pad with silica slurry planarizing surface, pressure map, scratch risk, and material removal contours
visual.scene.robot-warehouse-picker.package-flow.task-allocation-through.shelf-aisles-view|Robot warehouse picker|Package flow|Task allocation|Through|Warehouse aisles where robot pickers allocate tasks through package flow, shelf heatmaps, battery queues, and human safe zones
visual.scene.metal-melt-pool.stainless-powder.laser-solidification-along.scan-track-view|Metal melt pool|Stainless powder|Laser solidification|Along|Additive metal track where laser solidifies stainless powder, melt pool convection, keyhole risk, grain growth, and spatter particles
visual.scene.forging-grain-flow.hot-steel.plastic-deformation-under.press-die-view|Forging grain flow|Hot steel|Plastic deformation|Under|Hot steel billet deforming under press die with grain flow lines, temperature gradients, die friction, and residual stress map
visual.scene.glass-blowing.molten-glass.viscous-inflation-around.blowpipe-view|Glass blowing|Molten glass|Viscous inflation|Around|Molten glass bubble inflating around blowpipe, wall thickness colors, furnace heat shimmer, and artisan rotation path
visual.scene.paper-mill-pulp.cellulose-fibers.drainage-through.wire-section-view|Paper mill pulp|Cellulose fibers|Drainage|Through|Paper machine wire section where cellulose pulp drains through mesh, fiber orientation, vacuum boxes, and sheet formation bands
visual.scene.textile-dyeing.fabric-yarns.color-diffusion-across.dye-bath-view|Textile dyeing|Fabric yarns|Color diffusion|Across|Dye bath with fabric yarns absorbing color across weave, concentration gradients, temperature circulation, and fixation chemistry markers
visual.scene.cooking-emulsion.oil-water-droplets.shear-mixing-inside.sauce-vessel-view|Cooking emulsion|Oil water droplets|Shear mixing|Inside|Sauce vessel where oil and water droplets shear mix inside emulsion, surfactant shells, droplet size distribution, and heat zones
visual.scene.sourdough-fermentation.flour-water.microbe-gas-growth-through.dough-matrix-view|Sourdough fermentation|Flour water|Microbe gas growth|Through|Dough matrix where microbes grow gas bubbles through flour water network, gluten strands, acidity gradients, and fermentation rise curve
visual.scene.coffee-extraction.ground-beans.solute-washing-through.porous-bed-view|Coffee extraction|Ground beans|Solute washing|Through|Espresso puck with water washing solutes through porous coffee bed, channeling paths, pressure profile, crema foam, and extraction yield colors
visual.scene.granular-synthesis.sound-grains.temporal-cloud-inside.audio-space-view|Granular synthesis|Sound grains|Temporal cloud|Inside|3D audio space where sound grains form a temporal cloud, envelope shards, pitch color, density turbulence, and stereo field geometry
visual.scene.theater-crowd.people-agents.evacuation-routing-through.seat-aisles-view|Theater crowd evacuation|People agents|Evacuation routing|Through|Theater seating plan with people agents routing through aisles, exit capacities, panic pressure, and signage visibility cones
visual.scene.negotiation-network.strategy-agents.offer-convergence-between.participant-graph-view|Negotiation network|Strategy agents|Offer convergence|Between|Participant graph where strategy agents converge offers between parties, utility surfaces, trust edges, and concession trajectories
visual.scene.legal-precedent.case-nodes.citation-diffusion-through.court-graph-view|Legal precedent graph|Case nodes|Citation diffusion|Through|Court graph with case nodes diffusing precedent through citations, jurisdiction layers, conflict edges, and doctrine cluster surfaces
visual.scene.misinformation-cascade.message-packets.belief-spread-across.social-graph-view|Misinformation cascade|Message packets|Belief spread|Across|Social graph where message packets spread belief across communities, friction nodes, correction pulses, and polarization basins
visual.scene.voting-queue.voter-agents.service-delay-through.precinct-layout-view|Voting queue|Voter agents|Service delay|Through|Precinct layout with voter agents experiencing service delay through check-in stations, ballot booths, accessibility paths, and turnout pressure
visual.scene.public-health-triage.patient-agents.resource-allocation-between.clinic-zones-view|Public health triage|Patient agents|Resource allocation|Between|Clinic zones where patient agents receive resource allocation, acuity colors, staff constraints, and queue risk contours
visual.scene.classroom-concept-map.student-memory.knowledge-transfer-across.topic-network-view|Classroom concept map|Student memory|Knowledge transfer|Across|Topic network where student memory transfers knowledge across concepts, misconception knots, retrieval practice pulses, and mastery contours
visual.scene.memory-consolidation.neural-replay.pattern-strengthening-during.sleep-stage-view|Memory consolidation|Neural replay|Pattern strengthening|During|Sleep stage scene with neural replay strengthening memory patterns, hippocampal loops, cortical traces, and oscillation phase windows
visual.scene.wildfire-evacuation.vehicle-agents.route-choice-through.road-network-view|Wildfire evacuation|Vehicle agents|Route choice|Through|Road network where vehicle agents choose routes during wildfire evacuation, smoke fronts, road closures, and shelter capacity fields
visual.scene.insurance-risk-pool.policy-agents.loss-sharing-across.event-distribution-view|Insurance risk pool|Policy agents|Loss sharing|Across|Risk pool where policy agents share losses across event distributions, premium flows, reserve buffers, and correlated hazard clusters
visual.scene.city-zoning-shadow.building-masses.sunlight-allocation-between.parcel-blocks-view|City zoning shadow|Building masses|Sunlight allocation|Between|Urban parcel blocks where building masses allocate sunlight between lots, shadow volumes, zoning envelopes, and pedestrian comfort gradients
visual.scene.chemical-clock.belousov-solution.oscillation.inside.reaction-dish-view|Chemical clock|Belousov solution|Oscillation|Inside|3D reaction dish where chemical clock bands oscillate inside colored solution, with concentration waves, inhibitor fronts, and timing phase surfaces
visual.scene.polymer-curing.epoxy-resin.crosslinking.through.mold-cavity-view|Polymer curing|Epoxy resin|Crosslinking|Through|Transparent mold cavity where epoxy resin crosslinks through a polymer network, heat release pockets, gel front, and residual stress contours
visual.scene.crystal-nucleation.supersaturated-solution.growth.from.seed-lattice-view|Crystal nucleation|Supersaturated solution|Growth|From|Macro solution cell where crystals grow from seed lattice, nucleation bursts, solute depletion shells, and facet competition markers
visual.scene.electroplating-bath.nickel-ions.deposition.onto.cathode-surface-view|Electroplating bath|Nickel ions|Deposition|Onto|Industrial bath where nickel ions deposit onto cathode surface, electric field lines, bubble trails, thickness contours, and edge current crowding
visual.scene.paint-drying.pigment-film.solvent-evaporation.across.canvas-layer-view|Paint drying|Pigment film|Solvent evaporation|Across|Canvas cross section where pigment film dries through solvent evaporation, skin formation, crack risk, gloss gradients, and brush stroke ridges
visual.scene.ceramic-glaze.silica-melt.flow.over.vessel-surface-view|Ceramic glaze|Silica melt|Viscous flow|Over|Kiln view where silica glaze flows over vessel surface, pooling edges, thermal color bands, bubble defects, and cooling fracture lines
visual.scene.museum-preservation.paper-fibers.humidity-buffering.around.archive-case-view|Museum preservation|Paper fibers|Humidity buffering|Around|Archive display case where paper fibers buffer humidity around manuscript layers, airflow loops, acid migration, and light exposure fields
visual.scene.oil-paint-aging.linseed-film.oxidation.through.paint-cross-section-view|Oil paint aging|Linseed film|Oxidation|Through|Paint cross section where linseed film oxidizes through layered pigments, varnish yellowing, craquelure stress, and conservation sampling markers
visual.scene.music-festival.crowd-agents.sound-pressure-flow.between.stage-fields-view|Music festival crowd|Crowd agents|Sound pressure flow|Between|Festival grounds with crowd agents moving between sound pressure fields, speaker lobes, queue fronts, and heat stress shading
visual.scene.sports-stadium.fan-agents.exit-wave.through.concourse-network-view|Sports stadium egress|Fan agents|Exit wave|Through|Stadium concourse where fan agents exit through gate network, bottleneck waves, signage routing, and service capacity contours
visual.scene.restaurant-kitchen.heat-airflow.order-queue.between.cook-stations-view|Restaurant kitchen|Heat airflow|Order queue|Between|Commercial kitchen where order queue moves between cook stations, heat airflow plumes, staff paths, and plate timing buffers
visual.scene.hotel-elevator.guests.queueing.through.vertical-bank-view|Hotel elevator bank|Guests|Queueing|Through|High rise elevator bank with guest queues through vertical service groups, car dispatch decisions, wait time fields, and lobby congestion rings
visual.scene.fairground-ride.steel-arms.centripetal-load.around.rotor-frame-view|Fairground ride|Steel arms|Centripetal load|Around|Amusement ride rotor with steel arms carrying centripetal load around frame, seat swing arcs, fatigue hotspots, and safety envelope shells
visual.scene.skatepark-flow.rider-agents.trajectory-transfer.between.ramp-surfaces-view|Skatepark flow|Rider agents|Trajectory transfer|Between|Skatepark where rider agents transfer trajectories between ramp surfaces, momentum ribbons, collision zones, and skill basin colors
visual.scene.mountain-bike.suspension-linkage.impact-damping.over.rock-garden-view|Mountain bike suspension|Suspension linkage|Impact damping|Over|Bike suspension damping over rock garden with linkage motion, tire contact forces, shock heat, and rider stability envelope
visual.scene.ski-slope.snow-grains.edge-carving.along.turn-arc-view|Ski slope carving|Snow grains|Edge carving|Along|Ski edge carving through snow grains along turn arc, shear spray, friction heat, slope gradient, and balance force vectors
visual.scene.surf-break.water-surface.wave-breaking.over.reef-bathymetry-view|Surf break|Water surface|Wave breaking|Over|Coastal reef bathymetry where water surface breaks into surf waves, barrel vortices, rip current arrows, and surfer trajectory lanes
visual.scene.sailing-regatta.wind-field.tacking.between.boat-fleet-view|Sailing regatta|Wind field|Tacking|Between|Boat fleet tacking between wind field cells, sail pressure, wake interference, current drift, and tactical layline geometry
visual.scene.archery-range.carbon-arrow.flight-stability.through.crosswind-view|Archery range|Carbon arrow|Flight stability|Through|Arrow flight through crosswind with carbon shaft flex, spin stabilization, drag wake, sight line, and target impact probability cone
visual.scene.telescope-array.radio-dishes.beamforming.across.desert-baseline-view|Radio telescope array|Radio dishes|Beamforming|Across|Desert radio array beamforming across long baselines, delay lines, sky source lobes, interference masks, and calibration phase grids
visual.scene.deep-space-network.microwave-signals.link-budget.between.planet-probes-view|Deep space network|Microwave signals|Link budget|Between|Ground antennas linking microwave signals between planet probes, path loss cones, Doppler shift bands, and receiver noise surfaces
visual.scene.asteroid-mining.robotic-miners.material-sorting.around.rubble-site-view|Asteroid mining|Robotic miners|Material sorting|Around|Low gravity rubble site where robotic miners sort material around asteroid blocks, anchor tethers, dust lofting, and ore grade colors
visual.scene.mars-dust-storm.charged-dust.electrostatic-lifting.over.habitat-shell-view|Mars dust storm|Charged dust|Electrostatic lifting|Over|Martian habitat shell under dust storm with charged dust lifting over panels, visibility layers, abrasion risk, and solar loss contours
visual.scene.venus-balloon.sulfuric-clouds.buoyancy-control.inside.atmospheric-layer-view|Venus balloon|Sulfuric clouds|Buoyancy control|Inside|High atmosphere balloon controlling buoyancy inside sulfuric cloud layers, thermal tides, acid droplet shielding, and navigation flow bands
visual.scene.europa-ocean.ice-shell.tidal-flexing.under.surface-cracks-view|Europa ocean|Ice shell|Tidal flexing|Under|Icy moon cutaway where subsurface ocean flexes under ice shell, crack fields, brine pockets, and tidal heat contours
visual.scene.titan-river.methane-liquid.channel-flow.through.hydrocarbon-delta-view|Titan river|Methane liquid|Channel flow|Through|Hydrocarbon delta where methane liquid flows through branching channels, dune shadows, evaporation haze, and shoreline deposition bands
visual.scene.interstellar-dust.silicate-grains.radiation-pressure.through.nebula-stream-view|Interstellar dust|Silicate grains|Radiation pressure|Through|Nebula stream where silicate grains drift through radiation pressure, magnetic alignment, extinction bands, and star formation silhouettes
visual.scene.dark-matter-lens.mass-field.gravitational-shear.around.galaxy-cluster-view|Dark matter lens|Mass field|Gravitational shear|Around|Galaxy cluster view where invisible mass field shears background galaxies, lensing arcs, density contours, and uncertainty envelopes
visual.scene.population-genetics.allele-agents.selection-drift.across.island-network-view|Population genetics|Allele agents|Selection drift|Across|Island network where allele agents drift and select across populations, migration arrows, fitness contours, and bottleneck events
visual.scene.ecological-succession.plant-cohorts.competition.over.disturbed-landscape-view|Ecological succession|Plant cohorts|Competition|Over|Disturbed landscape where plant cohorts compete over terrain, shade cones, seed dispersal, nutrient patches, and recovery stage bands
visual.scene.predator-prey.fox-rabbit.population-cycles.across.landscape-grid-view|Predator prey cycles|Fox rabbit agents|Population cycles|Across|Landscape grid with fox and rabbit agents cycling across habitat patches, pursuit paths, birth pulses, and carrying capacity contours
visual.scene.pollinator-network.bee-agents.flower-visitation.through.meadow-graph-view|Pollinator network|Bee agents|Flower visitation|Through|Meadow graph where bee agents visit flowers through weighted paths, pollen transfer colors, nectar depletion, and habitat corridor gaps
visual.scene.fish-school.silver-bodies.alignment-flow.around.predator-shadow-view|Fish school|Silver bodies|Alignment flow|Around|Fish school aligning around predator shadow, local neighbor vectors, escape wave, density compression, and shimmering body orientation field
visual.scene.bird-flock.feathered-agents.collective-turning.above.thermal-column-view|Bird flock|Feathered agents|Collective turning|Above|Bird flock turning above thermal column with neighbor rules, lift spirals, wingbeat phase, and collision avoidance shells
visual.scene.animal-trail.mammal-agents.path-emergence.through.forest-floor-view|Animal trail|Mammal agents|Path emergence|Through|Forest floor where mammal agents create trail paths through repeated movement, scent gradients, vegetation wear, and obstacle avoidance
visual.scene.crop-rotation.soil-nutrients.replenishment.across.field-calendar-view|Crop rotation|Soil nutrients|Replenishment|Across|Field calendar where soil nutrients replenish across crop rotation blocks, root residue, nitrogen fixation, pest pressure, and yield memory
visual.scene.greenhouse-climate.air-moisture.feedback-control.inside.glass-house-view|Greenhouse climate|Air moisture|Feedback control|Inside|Glass greenhouse where air moisture feedback controls vents and mist, leaf temperature, sensor grids, and condensation risk surfaces
visual.scene.fish-farm.oxygen-water.aeration.through.tank-array-view|Fish farm|Oxygen water|Aeration|Through|Aquaculture tank array with oxygen water aerating through diffusers, fish density fields, waste plumes, and circulation loops
visual.scene.algae-bioreactor.green-cells.light-mixing.through.tube-loop-view|Algae bioreactor|Green cells|Light mixing|Through|Transparent tube loop where algae cells mix through light gradients, CO2 bubbles, biomass density, and harvest valve timing
visual.scene.compost-pile.organic-waste.heat-generation.inside.aerobic-core-view|Compost pile|Organic waste|Heat generation|Inside|Compost cutaway where organic waste generates heat inside aerobic core, oxygen diffusion, moisture pockets, and microbial activity bands
visual.scene.landfill-gas.waste-layers.methane-collection.through.well-network-view|Landfill gas|Waste layers|Methane collection|Through|Landfill section with methane collecting through well network, leachate paths, settlement layers, and gas pressure contours
visual.scene.recycling-sorter.mixed-materials.optical-classification.across.conveyor-line-view|Recycling sorter|Mixed materials|Optical classification|Across|Conveyor line where mixed materials are optically classified, air jets, item trajectories, contamination flags, and material color channels
visual.scene.construction-crane.steel-loads.sway-control.above.site-grid-view|Construction crane|Steel loads|Sway control|Above|Crane lifting steel loads above site grid with sway control, cable dynamics, wind gust vectors, and exclusion zone geometry
visual.scene.tunnel-boring.rock-face.cutting.through.subsurface-alignment-view|Tunnel boring|Rock face|Cutting|Through|Tunnel boring machine cutting through rock face, cutterhead torque, spoil conveyor flow, groundwater inflow, and alignment laser beams
visual.scene.mine-ventilation.airflow-dust.clearance.through.shaft-network-view|Mine ventilation|Airflow dust|Clearance|Through|Underground mine shaft network clearing airflow and dust, fan pressure, gas sensor halos, and evacuation refuge zones
visual.scene.earthquake-rupture.fault-rock.slip-propagation.along.subsurface-plane-view|Earthquake rupture|Fault rock|Slip propagation|Along|Fault plane where rupture slip propagates through rock, seismic wavefronts, stress drop colors, and aftershock cluster seeds
visual.scene.tsunami-generation.ocean-water.seafloor-displacement.over.subduction-edge-view|Tsunami generation|Ocean water|Seafloor displacement|Over|Subduction edge where seafloor displacement lifts ocean water, wave train initiation, coastal arrival bands, and bathymetry focusing
visual.scene.hurricane-eye.humid-air.angular-momentum.around.warm-core-view|Hurricane eye|Humid air|Angular momentum|Around|Warm core hurricane with humid air angular momentum around eye, eyewall towers, rainbands, pressure field, and ocean heat flux
visual.scene.tornado-debris.airborne-objects.vortex-lofting.inside.damage-path-view|Tornado debris|Airborne objects|Vortex lofting|Inside|Damage path where vortex lofts debris inside tornado, suction vortices, object trajectories, pressure scars, and warning polygon overlay
visual.scene.urban-heat-island.asphalt-roofs.heat-storage.across.city-block-view|Urban heat island|Asphalt roofs|Heat storage|Across|City block storing heat across asphalt roofs, canyon airflow, tree shade gaps, building albedo, and nighttime release contours
visual.scene.noise-pollution.traffic-sound.propagation.through.street-canyon-view|Noise pollution|Traffic sound|Propagation|Through|Street canyon where traffic sound propagates through reflections, facade absorption, human exposure zones, and mitigation barrier shadows
visual.scene.light-pollution.led-glow.scattering.above.city-atmosphere-view|Light pollution|LED glow|Scattering|Above|City atmosphere where LED glow scatters above streets, skyglow dome, spectrum bands, cloud amplification, and observatory impact cones
visual.scene.housing-market.household-agents.price-pressure.across.parcel-map-view|Housing market|Household agents|Price pressure|Across|Parcel map where household agents create price pressure across neighborhoods, affordability gradients, migration flows, and zoning constraints
visual.scene.transit-priority.bus-agents.signal-preemption.through.intersection-grid-view|Transit priority|Bus agents|Signal preemption|Through|Intersection grid where bus agents trigger signal preemption, queue jumps, passenger wait fields, and traffic delay redistribution
visual.scene.bike-network.rider-agents.safety-flow.between.protected-lanes-view|Bike network|Rider agents|Safety flow|Between|Protected lane network where rider agents choose safety flow between routes, conflict points, curb geometry, and comfort gradients
visual.scene.emergency-response.unit-agents.dispatch-routing.across.incident-map-view|Emergency response|Unit agents|Dispatch routing|Across|Incident map with emergency units dispatch routing across road network, station coverage, call priorities, and blocked street penalties
visual.scene.power-market.generator-agents.dispatch-bidding.through.grid-clearing-view|Power market|Generator agents|Dispatch bidding|Through|Electricity market where generator agents bid through grid clearing, marginal prices, transmission constraints, and renewable uncertainty bands
visual.scene.carbon-credit.project-agents.verification-flow.through.audit-ledger-view|Carbon credit audit|Project agents|Verification flow|Through|Audit ledger where project agents move carbon credit verification flow, baseline uncertainty, leakage arrows, and retirement receipt blocks
visual.scene.supply-demand.inventory-agents.bullwhip-oscillation.through.retail-network-view|Supply demand bullwhip|Inventory agents|Bullwhip oscillation|Through|Retail network where inventory agents create bullwhip oscillations, order delays, stockout waves, and warehouse buffer fields
visual.scene.cybersecurity-alert.network-packets.attack-propagation.across.service-graph-view|Cybersecurity alert|Network packets|Attack propagation|Across|Service graph where network packets propagate an attack, firewall cuts, lateral movement traces, alert severity, and recovery isolation zones
visual.scene.blockchain-mempool.transaction-agents.fee-competition.inside.blockspace-queue-view|Blockchain mempool|Transaction agents|Fee competition|Inside|Blockspace queue where transaction agents compete by fees, mempool layers, miner selection boundary, and congestion heat surface
visual.scene.recommendation-system.user-vectors.preference-drift.across.embedding-space-view|Recommendation system|User vectors|Preference drift|Across|Embedding space where user vectors drift across recommendations, cluster attractors, feedback loops, and exploration uncertainty shells
visual.scene.search-engine.index-shards.query-routing.through.ranking-pipeline-view|Search engine|Index shards|Query routing|Through|Ranking pipeline where query routing passes through index shards, lexical filters, vector recall, rerank stages, and latency bands
visual.scene.robot-surgery.tissue-mesh.force-feedback.across.instrument-tips-view|Robot surgery|Tissue mesh|Force feedback|Across|Surgical robot tips applying force feedback across tissue mesh, constraint zones, tremor filtering, and safety boundary halos
visual.scene.prosthetic-hand.sensor-skin.grip-adaptation.around.object-shape-view|Prosthetic hand|Sensor skin|Grip adaptation|Around|Prosthetic hand adapting grip around object shape, pressure sensors, tendon drives, slip prediction, and user intent signals
visual.scene.rehab-gait.muscle-activation.motor-learning.through.walkway-trials-view|Rehab gait|Muscle activation|Motor learning|Through|Rehabilitation walkway where muscle activation drives motor learning through repeated trials, balance markers, fatigue states, and therapist feedback
visual.scene.vaccine-cold-chain.vial-boxes.temperature-control.through.delivery-route-view|Vaccine cold chain|Vial boxes|Temperature control|Through|Delivery route where vial boxes maintain temperature control, thermal excursions, sensor receipts, and clinic arrival risk colors
visual.scene.hospital-bedflow.patient-agents.capacity-balancing.between.ward-units-view|Hospital bedflow|Patient agents|Capacity balancing|Between|Hospital wards balancing patient agents between units, discharge queues, staffing constraints, infection isolation, and bed turnover ribbons
visual.scene.water-treatment.biofilm-media.nitrification.through.filter-basin-view|Water treatment|Biofilm media|Nitrification|Through|Filter basin where biofilm media nitrifies water, oxygen gradients, ammonia conversion, sludge flow, and effluent quality bands
visual.scene.air-quality.pm-particles.dispersion.through.urban-valley-view|Air quality|PM particles|Dispersion|Through|Urban valley where particulate matter disperses through wind and buildings, exposure fields, inversion lid, and sensor network readings
visual.scene.desertification.soil-crust.vegetation-loss.across.dryland-front-view|Desertification front|Soil crust|Vegetation loss|Across|Dryland front where soil crust expands and vegetation loss spreads, wind erosion, grazing pressure, and rainfall memory patches
visual.scene.peatland-restoration.water-table.rewetting.across.ditch-network-view|Peatland restoration|Water table|Rewetting|Across|Peatland ditch network where water table rewetting spreads across peat, carbon flux, moss recovery, and fire risk reduction
visual.scene.oyster-reef.shell-beds.wave-attenuation.behind.living-breakwater-view|Oyster reef|Shell beds|Wave attenuation|Behind|Living breakwater where oyster shell beds attenuate waves, larval settlement, sediment trapping, and shoreline erosion reduction
visual.scene.nuclear-waste.canisters.heat-decay.inside.geologic-repository-view|Nuclear waste repository|Canisters|Heat decay|Inside|Geologic repository with canisters decaying heat inside tunnels, bentonite swelling, groundwater pathways, and dose isolation contours
visual.scene.fusion-stellarator.plasma-ribbon.magnetic-twist.inside.coil-cage-view|Fusion stellarator|Plasma ribbon|Magnetic twist|Inside|Stellarator coil cage twisting plasma ribbon inside magnetic surfaces, island chains, heat flux, and diagnostic sightlines
visual.scene.hydrogen-electrolyzer.water-molecules.splitting.between.membrane-stacks-view|Hydrogen electrolyzer|Water molecules|Splitting|Between|Electrolyzer membrane stack splitting water molecules between electrodes, bubble removal, ion flow, voltage losses, and cooling channels
visual.scene.ammonia-synthesis.nitrogen-hydrogen.reaction.inside.catalyst-bed-view|Ammonia synthesis|Nitrogen hydrogen|Reaction|Inside|Catalyst bed where nitrogen and hydrogen react into ammonia, pressure gradients, heat removal tubes, and equilibrium conversion bands`;
