...
const SOURCE_DIR = path.join(ROOT, 'tools/autonomy/data-sources/nyc-pedestrian-ramps-2026-07-13');
...
const OUTPUT_FILE = path.join(ROOT, 'public/data/autonomy/accessibility-index-v1.json');
