...
// public/data/autonomy/policies/resolution-performance-budgets-v1.json.
//
// Lanes:
...
const OUTPUT = path.join(ROOT, 'public/data/autonomy/evidence/resolution-performance-v1.json');
const FILES = Object.freeze({
  budgets: 'public/data/autonomy/policies/resolution-performance-budgets-v1.json',
  ...
  embeddingIndex: 'public/data/autonomy/place-embedding-index-v1.json',
  modelLock: 'public/data/simulatte-embedder/model-runtime-lock.json',
  fixture: 'tools/autonomy/fixtures/resolution-bench.html',
  resolver: 'public/runtime/neural-place-resolver.js',
  resolutionCore: 'public/runtime/neural-place-resolution-core.js',
  missionCompiler: 'public/mission/mission-compiler.js',
});
