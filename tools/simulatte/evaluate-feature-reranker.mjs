...
const OUTPUT = path.join(ROOT, 'public/data/simulatte/evidence/feature-reranker-public-diagnostic-v3.json');

function main() {
  const files = {
    world: 'public/data/simulatte/worlds/nyc-core-autonomy-v1.json',
    featureCatalog: 'public/data/simulatte/feature-cards-v1.json',
    embodiment: 'public/data/simulatte/embodiments/delivery-bike-v1.json',
    policy: 'public/data/simulatte/policies/bet-selector-v1.json',
    corpus: 'tools/samer/simulatte/public-navigation-missions-v2.json',
    runtime: 'public/simulatte/runtime/feature-retrieval.js',
  };
