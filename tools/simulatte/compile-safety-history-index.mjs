...
const SOURCE_DIR = path.join(ROOT, 'tools/simulatte/data-sources/nyc-safety-history-2025-07-to-2026-07');
...
const OUTPUT_FILE = path.join(ROOT, 'public/data/simulatte/safety-history-index-v1.json');
