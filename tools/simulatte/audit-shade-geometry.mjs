...
const WORLD_PATH = path.join(ROOT, 'public/data/simulatte/worlds/nyc-core-autonomy-v1.json');
const SOURCE_PATH = path.join(ROOT, 'tools/simulatte/data-sources/villages-williamsburg-2026-07-13/nyc-building-footprints.geojson.gz');
const OUTPUT_PATH = path.join(ROOT, 'public/data/simulatte/evidence/shade-geometry-audit-v1.json');
...
const receipt = {
  ...
  inputs: {
    ...
    compilerPath: 'tools/simulatte/build-nyc-autonomy-world.mjs',
  },
  buildingGeometry: {
