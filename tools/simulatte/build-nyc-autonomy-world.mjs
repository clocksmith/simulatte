...
const routingPolicy = JSON.parse(fs.readFileSync(path.join(ROOT, 'public/data/simulatte/policies/bet-selector-v1.json'), 'utf8'));
...
const DEFAULT_OUTPUT = path.join(ROOT, 'public/data/simulatte/worlds/nyc-core-autonomy-v1.json');
const DEFAULT_FEATURE_OUTPUT = path.join(ROOT, 'public/data/simulatte/feature-cards-v1.json');
const DEFAULT_OCCURRENCE_OUTPUT = path.join(ROOT, 'public/data/simulatte/patterns/nyc-replay-patterns-v1.json');
