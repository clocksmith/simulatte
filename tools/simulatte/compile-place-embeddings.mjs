...
const WORLD_PATH = 'public/data/simulatte/worlds/nyc-core-autonomy-v1.json';
const REGION_REGISTRY_PATH = 'public/data/simulatte/regions/nyc-core-v1.json';
const MODEL_LOCK_PATH = 'public/data/simulatte-embedder/model-runtime-lock.json';
const PLACE_SEMANTICS_DIR = 'tools/simulatte/data-sources/nyc-place-semantics-2026-07-13';
const PLACE_SEMANTICS_RECEIPT = `${PLACE_SEMANTICS_DIR}/snapshot-receipt.json`;
const OUTPUT_PATH = 'public/data/simulatte/place-embedding-index-v1.json';
