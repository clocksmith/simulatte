...
const SOURCE_DIR = path.join(ROOT, 'tools/simulatte/data-sources/nyc-bicycle-parking-2026-07-13');
...
const OUTPUT_FILE = path.join(ROOT, 'public/data/simulatte/route-amenity-index-v1.json');
