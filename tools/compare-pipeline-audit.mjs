...
const currentPath = path.resolve(process.argv[2] || path.join(auditDir, 'latest.json'));
const baselinePath = path.resolve(process.argv[3] || path.join(auditDir, 'baseline.json'));
